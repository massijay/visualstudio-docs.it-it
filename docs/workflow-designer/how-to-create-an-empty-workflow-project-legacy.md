...
helpviewer_keywords: 
  ...
  - "progetti, flusso di lavoro vuoto"
  - "flussi di lavoro, progetto del flusso di lavoro vuoto"
...
---
# Procedura: creare un progetto di flusso di lavoro vuoto (legacy)
Seguire questi passaggi per creare un progetto flusso di lavoro vuoto utilizzando la [!INCLUDE[wfd1](../workflow-designer/includes/wfd1_md.md)] legacy fornita da [!INCLUDE[vs2010](../modeling/includes/vs2010_md.md)].Utilizzare la [!INCLUDE[wfd2](../workflow-designer/includes/wfd2_md.md)] legacy quando è necessario fare riferimento a [!INCLUDE[netfx35_long](../workflow-designer/includes/netfx35_long_md.md)] o [!INCLUDE[vstecwinfx](../workflow-designer/includes/vstecwinfx_md.md)].  
  
### Per creare un progetto di flusso di lavoro vuoto  
...
5.  Nel riquadro **Modelli** selezionare **Progetto di flusso di lavoro vuoto**.  
