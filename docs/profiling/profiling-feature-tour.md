...
![Strumenti di diagnostica](../profiling/media/prof-tour-diagnostic-tools.png "Strumenti di diagnostica")
...
![Riepilogo degli strumenti di diagnostica](../profiling/media/prof-tour-cpu-and-memory-graph.gif "Riepilogo degli strumenti di diagnostica")
...
![Abilitazione Utilizzo CPU in Strumenti di diagnostica](../profiling/media/prof-tour-enable-cpu-profiling.png "Abilitazione Utilizzo CPU in Strumenti di diagnostica")
...
![Strumenti di diagnostica Utilizzo CPU](../profiling/media/prof-tour-cpu-usage.png "Strumenti di diagnostica Utilizzo CPU")

Fare doppio clic su una funzione che interessa per aprire una visualizzazione più dettagliata a tre riquadri, con la funzione selezionata al centro della finestra, la funzione chiamante a sinistra e le funzioni chiamate a destra. La sezione **Corpo funzione** indica la quantità totale di tempo (e la percentuale di tempo) impiegata nel corpo della funzione, escluso il tempo dedicato alle funzioni chiamanti e chiamate. Questi dati consentono di valutare se la funzione stessa è un collo di bottiglia delle prestazioni.

![Strumenti di diagnostica Visualizzazione Chiamante chiamato](../profiling/media/prof-tour-cpu-usage-caller-callee.png "Strumenti di diagnostica Visualizzazione Chiamante chiamato")
...
![Strumenti di diagnostica Crea snapshot](../profiling/media/prof-tour-take-snapshots.gif "Strumenti di diagnostica Crea snapshot")
...
![Strumenti di diagnostica Visualizzazione differenziale heap](../profiling/media/prof-tour-mem-usage-diff-heap.png "Strumenti di diagnostica Visualizzazione differenziale heap")
...
![Strumenti di diagnostica Visualizzazione Eventi](../profiling/media/prof-tour-events.png "Strumenti di diagnostica Visualizzazione Eventi")
...
![Strumenti di diagnostica Visualizzazione Eventi Analisi interfaccia utente](../profiling/media/prof-tour-ui-analysis.png "Strumenti di diagnostica Visualizzazione Eventi Analisi interfaccia utente")
...
![Panoramica profilatura Sequenza temporale dell'applicazione](../profiling/media/prof-tour-application-timeline.gif "Panoramica profilatura Sequenza temporale dell'applicazione")
...
![Diagramma utilizzo GPU](../profiling/media/prof-tour-gpu-usage.png "Diagramma utilizzo GPU")
...
![Diagramma uso della rete](../profiling/media/prof-tour-network-usage.png "Diagramma uso della rete")

Selezionare un'operazione nella visualizzazione di riepilogo per visualizzare altri dettagli.

![Diagramma dettagli uso della rete](../profiling/media/prof-tour-network-usage-details.png "Diagramma dettagli uso della rete")
...
![Esplora prestazioni](../profiling/media/prof-tour-performance-explorer.png "Esplora prestazioni")
