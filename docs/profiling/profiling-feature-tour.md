...
![Finestra Strumenti di diagnostica](~/docs/profiling/media/prof-tour-diagnostic-tools.png "Strumenti di diagnostica")
...
![Visualizzazione di riepilogo di Strumenti diagnostici](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "Riepilogo di Strumenti di diagnostica")
...
![Abilita profilatura CPU in Strumenti di diagnostica](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "Strumenti di diagnostica - Abilita profilatura CPU")
...
![Visualizzazione Utilizzo CPU in Strumenti di diagnostica](~/docs/profiling/media/prof-tour-cpu-usage.png "Strumenti di diagnostica - Utilizzo CPU")
...
![Visualizzazione in modalità "farfalla" delle funzioni chiamanti e chiamate in Strumenti di diagnostica](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "Strumenti di diagnostica - Visualizzazione delle funzioni chiamanti e chiamate")

## <a name="analyze-memory-usage"></a>Analizzare l'uso della memoria

La finestra Strumenti di diagnostica consente inoltre di valutare l'uso della memoria nell'applicazione. Ad esempio, è possibile esaminare il numero e le dimensioni degli oggetti nell'heap. Per istruzioni più dettagliate per l'analisi della memoria, vedere [Utilizzo memoria](../profiling/memory-usage.md).
...
![Visualizzazione degli eventi in Strumenti di diagnostica](~/docs/profiling/media/prof-tour-events.png "Strumenti di diagnostica - Visualizzazione degli eventi")
...
![Panoramica profilatura PerfTips](~/docs/profiling/media/prof-tour-perf-tips.png "Panoramica profilatura PerfTips")
...
![Visualizzazione degli eventi di analisi dell'interfaccia utente in Strumenti di diagnostica](~/docs/profiling/media/prof-tour-ui-analysis.png "Strumenti di diagnostica - Visualizzazione gli eventi di analisi dell'interfaccia utente")
...
![Profiler delle prestazioni](~/docs/profiling/media/prof-tour-performance-profiler.png "Profiler delle prestazioni")
...
![Strumento di profilatura Sequenza temporale applicazione](~/docs/profiling/media/prof-tour-application-timeline.gif "Panoramica delle funzionalità di profilatura - Sequenza temporale applicazione")
...
![Strumento di profilatura Utilizzo GPU](~/docs/profiling/media/prof-tour-gpu-usage.png "Finestra di dialogo dello strumento Utilizzo GPU")
...
![Strumento di profilatura Rete](~/docs/profiling/media/prof-tour-network-usage.png "Finestra di dialogo relativa all'utilizzo della rete")

Selezionare un'operazione nella visualizzazione di riepilogo per visualizzare altri dettagli.

![Informazioni dettagliate nello strumento Rete](~/docs/profiling/media/prof-tour-network-usage-details.png "Finestra di dialogo dei dettagli sull'utilizzo della rete")
...
![Strumento Esplora prestazioni](~/docs/profiling/media/prof-tour-performance-explorer.png "Esplora prestazioni")
