...
## <a name="span-category"></a>Categoria degli span  
 ...
 ![Cinque span in categorie diverse](~/docs/profiling/media/cvmarkerspancategory.png "CVMarkerSpanCategory")  
...
## <a name="span-aggregation-markers"></a>Marcatori di aggregazione di span  
 ...
 ![Marcatore span aggregato nel visualizzatore di concorrenza](~/docs/profiling/media/cvmarkerspanaggregate.png "CVMarkerSpanAggregate")  
