...
A partire da Visual Studio 2017, questi dati possono essere aperti con [GPUView](https://msdn.microsoft.com/library/windows/desktop/ff570133(v=vs.85).aspx) e [Windows Performance Analyzer](https://msdn.microsoft.com/windows/hardware/commercialize/test/wpt/windows-performance-analyzer) facendo clic sui collegamenti **Apri in GpuView** o **Apri in WPA** nella parte inferiore destra della sessione di diagnostica.
