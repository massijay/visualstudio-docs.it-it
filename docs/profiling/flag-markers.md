...
## <a name="alerts"></a>Avvisi  
 ...
 ![Marcatore di avviso del visualizzatore di concorrenza](~/docs/profiling/media/cvmarkeralert.png "CVMarkerAlert")  
Marcatore di avviso  
...
## <a name="aggregation-flags"></a>Flag di aggregazione  
 ...
 ![Flag aggregati con quattro livelli di importanza](~/docs/profiling/media/cvmarkeraggregate.png "CVMarkerAggregate")  
