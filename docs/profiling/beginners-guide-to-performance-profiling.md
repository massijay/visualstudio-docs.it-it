...
È anche possibile [guardare un video sull'uso degli strumenti di diagnostica](#video) che illustra come analizzare l'utilizzo della CPU e l'utilizzo della memoria.
