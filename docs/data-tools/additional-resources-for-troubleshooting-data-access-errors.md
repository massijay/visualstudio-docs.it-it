---
title: "Risorse aggiuntive per la risoluzione dei problemi di accesso ai dati | Microsoft Docs"
ms.custom: ""
ms.date: "09/21/2016"
...
dev_langs: 
  ...
  - "aspx"
helpviewer_keywords: 
  - "dati [Visual Studio], risoluzione dei problemi"
  - "accesso ai dati [Visual Studio], risoluzione dei problemi"
  - "adattatori dati, risoluzione dei problemi"
  - "dataset [Visual Basic], riempimento che genera eccezioni"
  - "dataset [Visual Basic], risoluzione dei problemi"
  - "transazioni [Visual Studio], risoluzione dei problemi"
  - "risoluzione dei problemi di accesso ai dati"
...
---
# Risorse aggiuntive per la risoluzione dei problemi di accesso ai dati
È possibile trovare assistenza per la risoluzione dei problemi relativi a errori e avvisi nei forum pubblici MSDN \(Microsoft Developer Network\).  Nella tabella seguente sono elencati i forum relativi ai dati disponibili in MSDN.  
  
 [Windows Forms Data Controls and Databinding](http://go.microsoft.com/fwlink/?LinkId=160179)  
 Forum dedicato a domande e discussioni generali relative all'accesso ai dati in Windows Form.  
  
 [ADO.NET DataSet Forum](http://go.microsoft.com/fwlink/?LinkId=160180)  
 Forum dedicato a domande e discussioni di carattere generale sui dataset.  
  
 [ADO.NET Entity Framework and LINQ to Entities](http://go.microsoft.com/fwlink/?LinkId=191520)  
 Forum dedicato a domande e discussioni generali relative alle applicazioni Entity Framework e al linguaggio LINQ to Entities.  
  
 [WCF Data Services Forum](http://go.microsoft.com/fwlink/?LinkId=160181)  
 Forum dedicato a domande e discussioni di carattere generale sui servizi dati.  
  
 [SQL Server Data Access Forum](http://go.microsoft.com/fwlink/?LinkID=160184)  
 Forum dedicato a domande e discussioni generali relative all'accesso ai dati in Microsoft SQL Server.  
  
 [Linq to SQL Forum](http://go.microsoft.com/fwlink/?LinkId=160183)  
 Forum dedicato a domande e discussioni di carattere generale su Linq to SQL.  
  
 [ADO.NET Data Providers Forum](http://go.microsoft.com/fwlink/?LinkId=160182)  
 Forum dedicato a domande e discussioni generali relative a provider di dati .NET Framework diversi.  
  
 Per informazioni su come risolvere i problemi di connettività a SQL Server, vedere [Risoluzione dei problemi relativi alla connessione al motore del database di SQL Server](http://go.microsoft.com/fwlink/?LinkID=246151).  
