...
|------------|-----------------------------|  
|Disporre il flusso delle dipendenze per l'intera mappa in una direzione specifica. In questo modo si potranno vedere i livelli di architettura nel codice.|Sulla barra degli strumenti della mappa, scegliere **Layout**e quindi:<br /><br /> -   **Dall'alto verso il basso** ![dall'alto verso il pulsante grafico in basso](~/docs/modeling/media/topbottomgraphbutton.gif "TopBottomGraphButton")<br />-   **Dal basso in alto** ![inferiore al pulsante grafico in alto](~/docs/modeling/media/bottomtopgraphbutton.gif "BottomTopGraphButton")<br />-   **Da sinistra a destra** ![pulsante layout destra a sinistra](~/docs/modeling/media/leftrightgraphbutton.gif "LeftRightGraphButton")<br />-   **Da destra a sinistra** ![da destra a pulsante grafico a sinistra](~/docs/modeling/media/rightleftgraphbutton.gif "RightLeftGraphButton")|  
|Visualizzare cluster di dipendenze naturali all'interno del codice con i nodi che presentano un maggior numero di dipendenze al centro dei cluster e quelli con meno dipendenze all'esterno.|Sulla barra degli strumenti della mappa, scegliere **Layout**e quindi **raggruppamenti veloci**![pulsante raggruppamenti veloci sulla barra degli strumenti grafico](~/docs/modeling/media/quickclustersicon.gif "QuickClustersIcon").|  
...
|Modificare il layout all'interno di un gruppo.|Selezionare il gruppo, aprire il menu di scelta rapida, scegliere **Layout**e selezionare lo stile di layout desiderato.<br /><br /> -oppure-<br /><br /> 1.  Selezionare il gruppo e verificare che sia espanso.<br />2.  Fare di nuovo clic sull'intestazione del gruppo. Verrà visualizzata la barra degli strumenti del gruppo.<br />     ![Grafico delle dipendenze - barra degli strumenti di gruppo](~/docs/modeling/media/dependencygraph_group.png "DependencyGraph_Group")<br />3.  Aprire il **modificare lo stile di layout del gruppo** elenco ![layout del grafico - gruppo della barra degli strumenti - dipendenza](~/docs/modeling/media/dependencygraph_grouptoolbar.gif "DependencyGraph_GroupToolbar") e scegliere lo stile di layout desiderato.<br /><br /> **Visualizzazione elenco** Riorganizza i membri del gruppo nell'elenco. **Grafico predefinito** Reimposta il layout del gruppo per il layout predefinito della mappa. Per altre opzioni, vedere [modificare il layout della mappa](#Selecting).|  
...
1.  Selezionare l'elemento di codice sorgente. Sopra l'elemento di codice viene visualizzata una barra degli strumenti.  
     ...
     ![Barra degli strumenti grafico delle dipendenze](~/docs/modeling/media/depedencygraph_toolbar.png "DepedencyGraph_Toolbar")  
...
2.  Se l'elemento o il collegamento fa parte di un gruppo, il **recupera di nuovo figli** pulsante ![recupera di nuovo figli icona](~/docs/modeling/media/dependencygraph_deletednodesicon.png "DependencyGraph_DeletedNodesIcon") viene visualizzato all'interno del gruppo. Fare clic su questo pulsante per recuperare elementi e collegamenti mancanti.  
