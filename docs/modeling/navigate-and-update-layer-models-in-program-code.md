...
## <a name="dependency-links"></a>Collegamenti di dipendenza  
 ...
 ![Oggetto ILayerDependencyLink che connette due ILayers. ] (~/docs/modeling/media/layerapi_dependency.png "LayerApi_Dependency")  
...
## <a name="comments"></a>Commenti  
 ...
 ![È possibile associare commenti a qualsiasi elemento livello. ] (~/docs/modeling/media/layerapi_comments.png "LayerApi_Comments")  
...
```  
 ...
 ![Ogni oggetto ILayerElement è presentato da un oggetto IShape. ] (~/docs/modeling/media/layerapi_shapes.png "LayerApi_Shapes")  
