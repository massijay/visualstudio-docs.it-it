---
title: Creare modelli per app | Documenti di Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|**Diagramma**|**Mostra**|  
|-----------------|---------------|  
|[Diagrammi di dipendenza: linee guida](../modeling/layer-diagrams-guidelines.md)<br /><br /> [Diagrammi di dipendenza: riferimento](../modeling/layer-diagrams-reference.md)|Architettura di alto livello del sistema|  
...
|**Argomento**|**Attività**|  
|---------------|--------------|  
|[Visualizzare il codice](../modeling/visualize-code.md)|Creare mappe codice e diagrammi di dipendenza per meglio comprendere il codice familiarità.|  
...
|[Usare modelli nel processo di sviluppo](../modeling/use-models-in-your-development-process.md)<br /><br /> [Utilizzare i modelli in Agile development](http://msdn.microsoft.com/en-us/592ac27c-3d3e-454a-9c38-b76658ed137f)|Usare i modelli per comprendere e modificare il sistema durante lo sviluppo.|  
