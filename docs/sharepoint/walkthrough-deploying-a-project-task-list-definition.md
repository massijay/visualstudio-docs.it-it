...
2.  Nella finestra di dialogo **Pubblica**, scegliere il pulsante di opzione **Pubblica su file system**.  
     ...
     È possibile modificare il percorso di destinazione nella finestra di dialogo **Pubblica** scegliendo il pulsante con i puntini di sospensione ![Icona con i puntini di sospensione](~/docs/sharepoint/media/ellipsisicon.gif "Icona con i puntini di sospensione") e passando ad un'altra posizione.  
