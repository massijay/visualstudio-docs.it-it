...
La voce di menu **R Tools > Impostazioni di Data Science** configura anche l'IDE di Visual Studio con un layout ottimizzato per le esigenze dei data scientist. In particolare, questa opzione consente di aprire le finestre [R interattivo](interactive-repl.md), [Esplora variabili](variable-explorer.md) e [Aree di lavoro](workspaces.md):
