...
![Visualizzazione di una firma della funzione di IntelliSense](~/docs/rtvs/media/intellisense-function-signature.png) 
...
![Menu di completamento automatico di IntelliSense](~/docs/rtvs/media/intellisense-auto-complete-menu.png)
...
![Suggerimenti di IntelliSense per i membri di un oggetto](~/docs/rtvs/media/intellisense-auto-complete-r-objects.png)
...
![Supporto per la firma per una funzione di IntelliSense](~/docs/rtvs/media/intellisense-function-signature.png)
...
![IntelliSense per funzioni definite dall'utente](~/docs/rtvs/media/intellisense-same-file-functions.png)

![Completamento parametri di IntelliSense per funzioni definite dall'utente](~/docs/rtvs/media/intellisense-parameter-completion.png)

IntelliSense viene applicato anche a variabili nello stesso file e nella sessione corrente:

![Completamento variabili di IntelliSense](~/docs/rtvs/media/intellisense-variable-completion.png)
...
![Smart tag per R nell'editor](~/docs/rtvs/media/intellisense-smart-tags.png)
