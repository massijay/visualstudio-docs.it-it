...
2.  Nel nuovo progetto, controllare **unittest1.cpp**  
     ...
     ![Progetto di test con TEST&#95;CLASS e TEST&#95;METHOD](~/docs/test/media/utecpp2.png "UteCpp2")  
...
3.  Verificare che i test vengano eseguiti in Esplora test:  
    ...
    2.  Dal menu **Test** , scegliere **Esegui** , **Tutti i test**.  
         ...
         ![Esplora unit test con un test superato](~/docs/test/media/utecpp04.png "UteCpp04")  
...
3.  Dichiarare una funzione esportata nel file .h principale:  
     ...
     ![Nuovo progetto di codice DLL e file h con macro API](~/docs/test/media/utecpp07.png "UteCpp07")  
...
5.  In Esplora test scegliere **Esegui tutto**.  
     ...
     ![Esplora unit test &#45; Test di base superato](~/docs/test/media/utecpp10.png "UteCpp10")  
