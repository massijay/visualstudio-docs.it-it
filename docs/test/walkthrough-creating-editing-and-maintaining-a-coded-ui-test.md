...
1.  Nel menu **FILE** scegliere **Nuovo**, quindi selezionare **Progetto**.  
  
     Verrà visualizzata la finestra di dialogo **Nuovo progetto**.  
  
2.  Nel riquadro **Installato** espandere **Visual C\#**, quindi selezionare **Windows Desktop**.  
...
12. Selezionare il controllo Checkbox.  Nella finestra Proprietà modificare il valore della proprietà **Name** da \<No Name\> a checkBox1, quindi deselezionare la proprietà **IsEnabled**.  
  
     ![Applicazione WPF semplice](../test/media/codedui_wpfapp.png "CodedUI\_WPFApp")  
  
13. Fare doppio clic sul pulsante per aggiungere un gestore eventi Click.  
  
     MainWindow.xmal.cs viene visualizzato nell'Editor di codice con il cursore nel nuovo metodo button1\_Click.  
...
15. Nel metodo button1\_Click aggiungere il codice seguente:  
...
1.  Individuare l'applicazione SimpleWPFApp creata precedentemente.  Per impostazione predefinita, l'applicazione è salvata in C:\\Users\\\<nomeutente\>\\Documenti\\Visual Studio \<versione\>\\Projects\\SimpleWPFApp\\SimpleWPFApp\\bin\\Debug\\SimpleWPFApp.exe  
...
3.  In Esplora soluzioni fare clic con il pulsante destro del mouse sulla soluzione, scegliere **Aggiungi**, quindi **Nuovo progetto**.  
  
     Verrà visualizzata la finestra di dialogo **Aggiungi nuovo progetto**.  
  
4.  Nel riquadro **Installato** espandere **Visual C\#**, quindi selezionare **Test**.  
...
8.  Scegliere **Avvia registrazione** in UIMap \- Generatore di test codificati dell'interfaccia utente.  
     ...
     ![Avviare la registrazione](../test/media/cuit_builder_record.png "CUIT\_Builder\_Record")  
  
     Se necessario, è possibile sospendere la registrazione, ad esempio per controllare la posta elettronica in arrivo.  
  
     ![Sospendere la registrazione](../test/media/cuit_.png "CUIT\_")  
...
1.  Nella finestra Esplora test selezionare il test non riuscito, quindi nella sezione **StackTrace** scegliere il primo collegamento a **UIMap.SimpleAppTest\(\)**.  
...
9. Nella barra degli strumenti di [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)], scegliere **Salva**.  
...
16. Questa volta tutti i passaggi del test codificato dell'interfaccia utente sono completati e nella finestra Esplora test è visualizzato **Superato**.  
...
5.  Nella sezione **StackTrace** della finestra Esplora test scegliere il primo collegamento accanto a **UIMpa.ModifiedSimpleAppTest\(\)**.  
     ...
     Sarà aperto il file UIMap.cs.  Il punto di errore è evidenziato nel codice:  
...
1.  Nel file CodedUITest1.cs fare clic con il pulsante destro del mouse sul metodo **CodedUITestMethod1\(\)**, scegliere **Genera codice per test codificato dell'interfaccia utente**, quindi fare clic su **Usa il generatore di test codificati dell'interfaccia utente**.  
...
### Video  
 ![Collegamento a video](../data-tools/media/playvideo.png "PlayVideo") [Test codificati dell'interfaccia utente \- Approfondimento \- Episodio1 \-Introduzione](http://go.microsoft.com/fwlink/?LinkID=230573)  
  
 ![Collegamento a video](../data-tools/media/playvideo.png "PlayVideo") [Test codificati dell'interfaccia utente \- Approfondimento \- Episodio2 \- Manutenzione e debug](http://go.microsoft.com/fwlink/?LinkID=230574)  
  
 ![Collegamento a video](../data-tools/media/playvideo.png "PlayVideo") [Test codificati dell'interfaccia utente \- Approfondimento \- Episodio3 \- Codifica manuale](http://go.microsoft.com/fwlink/?LinkID=230575)  
...
## Vedere anche  
 ...
 [Guida introduttiva a Progettazione WPF](http://msdn.microsoft.com/it-it/18e61d03-b96a-4058-a166-8ec6b3f6116b)   
 [Configurazioni e piattaforme supportate per i test codificati dell'interfaccia utente e le registrazioni delle azioni](../test/supported-configurations-and-platforms-for-coded-ui-tests-and-action-recordings.md)   
 [Modifica di test codificati dell'interfaccia utente utilizzando l'editor di test codificato dell'interfaccia utente](../test/editing-coded-ui-tests-using-the-coded-ui-test-editor.md)