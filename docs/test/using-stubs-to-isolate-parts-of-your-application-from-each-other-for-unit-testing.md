---
title: "Utilizzo di stub per isolare le parti dell&#39;applicazione l&#39;una dall&#39;altra per gli unit test | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
-   [Come usare gli stub](#how)  
    ...
    -   [Progettare l'inserimento di dipendenza](#Dependency)  
...
2.  Le classi sealed o i metodi statici non possono essere sottoposti a stub perché i tipi stub usano l'invio di metodi virtuali.  Per casi di questo tipo, usare tipi shim come descritto in [Utilizzo di shim per isolare l'applicazione dagli altri assembly per gli unit test](../test/using-shims-to-isolate-your-application-from-other-assemblies-for-unit-testing.md)  
