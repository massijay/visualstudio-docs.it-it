---
title: "Utilizzo di emulatori per isolare gli unit test per le applicazioni di SharePoint 2010 | Microsoft Docs"
ms.custom: ""
ms.date: "12/11/2016"
...
manager: "douge"
---
# Utilizzo di emulatori per isolare gli unit test per le applicazioni di SharePoint 2010
...
-   Pacchetto NuGet di emulatori di Microsoft SharePoint  
 ...
 È inoltre necessario avere familiarità con le [nozioni di base sugli unit test in Visual Studio](../test/unit-test-basics.md) e una discreta conoscenza di [Microsoft Fakes](../test/isolating-code-under-test-with-microsoft-fakes.md).  
...
##  <a name="BKMK_The_AppointmentsWebPart_example"></a> Esempio di AppointmentsWebPart  
 ...
 ![Web part di appuntamenti](../test/media/ut_emulators_appointmentswebpart.png "UT\_EMULATORS\_AppointmentsWebPart")  
...
3.  Nella categoria **Online** cercare `Microsoft.SharePoint.Emulators` e quindi scegliere **Installa**.  
 ...
 ![Pacchetto NuGet di emulatori di SharePoint](../test/media/ut_emulators_nuget.png "UT\_EMULATORS\_Nuget")  
...
```  
 ...
 ![Flusso di esecuzione dell'emulatore](../test/media/ut_emulators_flowchart.png "UT\_EMULATORS\_FlowChart")  
...
2.  Ricompilare il progetto di test almeno una volta dopo aver installato il pacchetto di emulatori di Microsoft SharePoint e se il file Microsoft.SharePoint.Fakes è stato modificato.  La compilazione del progetto consente di creare e popolare una cartella **FakesAssembly** nella cartella radice del progetto su disco.  
     ...
     ![Cartella FakesAssembly](../test/media/ut_emulators_fakesassemblyfolder.png "UT\_EMULATORS\_FakesAssemblyFolder")  
