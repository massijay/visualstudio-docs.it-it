---
title: "Modifica di test codificati dell&#39;interfaccia utente utilizzando l&#39;editor di test codificato dell&#39;interfaccia utente | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
helpviewer_keywords: 
  - "test codificato dell'interfaccia utente, Editor di test codificati dell'interfaccia utente"
...
##  <a name="CodedUITestEditor_EditActionAndControlProperties"></a> Modificare le proprietà delle azioni dell'interfaccia utente e le proprietà dei controlli corrispondenti  
 ...
 ![Proprietà di un'azione dell'interfaccia utente](../test/media/codeduiedituiaction.png "CodedUIEditUIAction")  
...
Modificare le proprietà del controllo  
 ...
 Dopo avere completato le modifiche, salvarle nel file UIMap.Designer scegliendo **Salva** sulla barra degli strumenti di [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
...
-   ![Suggerimento](../test/media/tip.png "Tip") Potrebbe essere necessario espandere il controllo contenitore che include il controllo che si vuole modificare.[!INCLUDE[crdefault](../test/includes/crdefault_md.md)] [Individuazione di un controllo e dei discendenti](#CodedUITestEditor_LocateDecendants) più avanti in questo argomento.  
...
-   ![Suggerimento](../test/media/tip.png "Tip") È possibile rinominare il nuovo metodo. Selezionarlo nel riquadro Azioni dell'interfaccia utente e scegliere il pulsante **Rinomina** nella barra degli strumenti dell'Editor di test codificati dell'interfaccia utente.  
...
-   ![Icona Caution](../test/media/caution.png "caution") **Avviso:** prima di individuare un controllo dell'interfaccia utente, verificare che l'applicazione associata al test sia in esecuzione.  
...
-   ![Icona Caution](../test/media/caution.png "caution") **Avviso:** prima di individuare i controlli dell'interfaccia utente, verificare che l'applicazione associata al test sia in esecuzione.  
