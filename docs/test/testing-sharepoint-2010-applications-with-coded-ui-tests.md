...
-   ![Prerequisito](~/docs/test/media/prereq.png "Prereq") I test codificati dell'interfaccia utente per le applicazioni SharePoint sono supportati solamente con SharePoint 2010.  
  
-   ![Prerequsite](~/docs/test/media/prereq.png "Prereq") Il supporto per i controlli Visio e PowerPoint 2010 nell'applicazione SharePoint non è previsto.  
...
## <a name="creating-a-coded-ui-test-for-your-sharepoint-app"></a>Creazione di un test codificato dell'interfaccia utente per l'applicazione SharePoint  
 ...
 ![Web part di SharePoint](~/docs/test/media/cuit_sharepoint.png "CUIT_SharePoint")  
