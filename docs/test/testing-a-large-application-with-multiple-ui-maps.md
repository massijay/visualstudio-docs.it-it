...
ms.topic: "article"
helpviewer_keywords: 
  - "test codificati dell'interfaccia utente, per applicazioni di grandi dimensioni"
  - "test codificati dell'interfaccia utente, più mappe dell'interfaccia utente"
...
## Situazioni in cui sono necessarie più mappe dell'interfaccia utente  
...
#### Per aggiungere una mappa dell'interfaccia utente al progetto di test codificato dell'interfaccia utente  
  
1.  In **Esplora soluzioni** fare clic con il pulsante destro del mouse sul file del progetto di test codificato dell'interfaccia utente, scegliere **Aggiungi** e quindi **Nuova cartella** per creare una cartella nel progetto di test codificato dell'interfaccia utente per archiviare tutte le mappe dell'interfaccia utente.  Ad esempio, la cartella potrebbe essere denominata `UIMaps`.  
