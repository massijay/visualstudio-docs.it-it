...
4.  Nel progetto di unit test aggiungere un riferimento al progetto di codice da testare, che nell'esempio corrisponde al progetto Accounts.  
 ...
 Ogni progetto di unit test contiene classi che rispecchiano i nomi delle classe del progetto di codice. Nell'esempio il progetto `AccountsTests` contiene le classi seguenti:  
...
###  <a name="BKMK_Running_tests_after_every_build"></a> Eseguire i test dopo ogni compilazione  
