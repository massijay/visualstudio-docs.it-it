---
title: "Procedura dettagliata: Applicazione desktop WPF | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Procedura dettagliata: Applicazione desktop WPF
...
4.  Nella casella di testo **Nome** immettere `ExpenseIt`, quindi scegliere il pulsante **OK**.  
...
#### Per modificare la finestra principale  
...
4.  Nella finestra **Proprietà** espandere il nodo della categoria **Common** e scegliere la proprietà **Title**, quindi immettere `ExpenseIt` e premere **INVIO**.  
...
#### Per modificare il file code\-behind \(C\#\)  
...
#### Per aggiungere una finestra dei dettagli  
...
2.  Nella finestra **Proprietà** espandere il nodo della categoria **Layout** e impostare i valori **Margin** su `10`, `10`, `0` e `10`, che corrispondono ai margini sinistro, destro, superiore e inferiore.  
...
#### Per aggiungere il codice al pulsante  
...
2.  Scegliere l'elemento `<Button` e aggiungere il codice XAML seguente subito dopo l'elemento **HorizontalAlignment\="Right"**: `Click="Button_Click"`.  
     ...
     Viene aggiunto un gestore eventi per l'evento `Click` di Button. Il codice dell'elemento **\<Button** dovrebbe essere visualizzato come segue:  
...
#### Per creare l'interfaccia utente per la pagina del report  
...
#### Per associare i dati a un controllo  
...
#### Per connettere i dati ai controlli  
...
#### Per aggiornare l'interfaccia utente con i modelli di dati  
  
1.  Aprire **ExpenseReportPage.xaml**.  
  
2.  Sostituire il codice XAML per gli elementi **Name** e **Department** `<StackPanel` con quanto segue:  
...
## Vedere anche  
 [Procedura dettagliata: Creare un'applicazione desktop WPF connessa a un servizio mobile di Azure](../Topic/Walkthrough:%20Create%20a%20WPF%20Desktop%20Application%20connected%20to%20an%20Azure%20Mobile%20Service.md)   
