...
## <a name="creating-a-basic-texture"></a>Creazione di una trama di base  
 ...
 ![Destinazione "Bullseye" con trasparenza visualizzata in verde](~/docs/designers/media/digit-bullseye-texture-in-editor.png "Digit-Bullseye-Texture-In-Editor")  
...
17. Disegnare un altro cerchio dalla coordinata in pixel `(192, 192)` alla coordinata in pixel `(320, 320)`.  
 ...
 ![Trama di destinazione "bullseye" completa](~/docs/designers/media/gfx_image_demo_bullseye.png "gfx_image_demo_bullseye")  
