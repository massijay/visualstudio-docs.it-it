...
2. Premere **Ctrl+.** in un punto qualsiasi della riga per richiamare la lampadina e passare direttamente all'elenco delle correzioni potenziali.  
   ...
   ![Lampadina con passaggio del mouse](~/docs/ide/media/vs2015_lightbulb_hover.png "VS2017_LightBulb_Hover")  
...
![Refactoring: risolvere i conflitti di unione](~/docs/ide/media/vside-refactoring-merge-conflicts.png)
...
![Refactoring: aggiungere un controllo null](~/docs/ide/media/vside-refactoring-nullcheck.png)
...
![Refactoring: generare costruttori](~/docs/ide/media/vside-refactoring-constructors.png)
...
![Refactoring: variabili non usate](~/docs/ide/media/vside-refactoring-unusedvars.png)
...
![Refactoring: sostituzioni](~/docs/ide/media/vside-refactoring-overrides.png)

![Refactoring: finestra di dialogo per le sostituzioni](~/docs/ide/media/vside-refactoring-overrides-dialog.png)
...
![Refactoring: modificare la base](~/docs/ide/media/vside-refactoring-changebase1.png)

![Refactoring: modificare la base](~/docs/ide/media/vside-refactoring-changebase2.png)
...
![Refactoring: modificare i separatori di cifre](~/docs/ide/media/vside-refactoring-separators.png)
