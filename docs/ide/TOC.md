...
## [Introduzione al debug in Visual Studio 2015](getting-started-with-debugging-in-visual-studio.md)
...
## [Effettuare il refactoring in Visual Studio](refactoring-in-visual-studio.md)
### [Anteprima modifiche](preview-changes.md)
## [Generazione di codice in Visual Studio](code-generation-in-visual-studio.md)
...
## [Creare impostazioni personalizzate e portabili per l'editor](create-portable-custom-editor-options.md)
