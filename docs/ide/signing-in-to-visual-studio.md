...
## <a name="how-to-sign-in-to-visual-studio"></a>Come accedere a Visual Studio  
 ...
 A meno che non esegua la disconnessione, l'utente viene automaticamente connesso a Visual Studio a ogni avvio e tutte le modifiche apportate alle impostazioni sincronizzate vengono applicate automaticamente. Per disconnettersi, scegliere la freccia in giù accanto al nome del profilo nell'ambiente Visual Studio, scegliere il comando **Impostazioni account** , quindi scegliere il collegamento **Esci** . Per accedere di nuovo, scegliere il comando **Accedi** nell'angolo superiore destro dell'ambiente Visual Studio.  

## <a name="to-change-your-profile-information"></a>Per modificare le informazioni sul profilo  
 
1.  Passare a **File > Impostazioni account** e selezionare il collegamento **Gestisci profilo di Visual Studio**.  

1.  Nel browser selezionare il nome dell'account nella parte superiore e quindi selezionare **Profilo di Visual Studio**.  

1.  Selezionare **Modifica profilo** e modificare le impostazioni desiderate.  

1.  Al termine selezionare **Salva modifiche**.
