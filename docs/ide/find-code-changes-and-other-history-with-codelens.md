...
-   Codice di Visual C# .NET o Visual Basic .NET  
 ...
 ![CodeLens &#45; Posizionare il puntatore su un riferimento](~/docs/ide/media/codelensviewreferencespeekreference.png "CodeLensViewReferencesPeekReference")  
...
-   [Lync 2010 o versioni successive oppure Skype for Business](http://technet.microsoft.com/en-us/lync)per contattare il team dall'editor di codice.  
 ...
 ![Indicatori a livello di elemento di codice](~/docs/ide/media/codelenselementlevelindicators.png "CodeLensElementLevelIndicators")  
 ...
 ![Indicatori CodeLens a livello di file](~/docs/ide/media/almcodelensfilelevelindicators.png "ALMCodeLensFileLevelIndicators")  
 ...
 ![Premere ALT per visualizzare i numeri di accesso della tastiera](~/docs/ide/media/codelensaltkeyindicators.png "CodeLensAltKeyIndicators")  
...
### <a name="find-changes-in-your-code"></a>Individuare le modifiche nel codice  
 ...
 ![CodeLens: ottenere la cronologia delle modifiche per il codice nel controllo della versione di Team Foundation](~/docs/ide/media/codelenscodechanges.png "CodeLensCodeChanges")  
 ...
 ![Visualizzare tutte le modifiche apportate al codice](~/docs/ide/media/codelensshowsallchanges.png "CodeLensShowsAllChanges")  
  
 Verrà visualizzata la finestra Cronologia per i set di modifiche.  
  
 ![Finestra Cronologia per tutte le modifiche al codice](~/docs/ide/media/codelenscodechangeshistory.png "CodeLensCodeChangesHistory")  
 ...
 ![CodeLens: ottenere la cronologia delle modifiche per il codice nel repository Git](~/docs/ide/media/codelenscodechangesgit.png "CodeLensCodeChangesGit")  
...
#### <a name="find-incoming-changes-from-other-branches"></a>Individuare le modifiche in arrivo da altri branch  
 ![CodeLens: individuare le modifiche al codice in altri branch](~/docs/ide/media/codelensbranchchangecheckinconceptual.png "CodeLensBranchChangeCheckinConceptual")  
...
|--------------|-----------------------------------------|  
|![CodeLens: icona di modifica da branch corrente](~/docs/ide/media/codelensbranchcurrenticon.png "CodeLensBranchCurrentIcon")|Branch corrente|  
|![CodeLens &#45; Icona di modifica da branch padre](~/docs/ide/media/codelensbranchparenticon.png "CodeLensBranchParentIcon")|Branch padre|  
|![CodeLens: icona di modifica da branch figlio](~/docs/ide/media/codelensbranchchildicon.png "CodeLensBranchChildIcon")|Branch figlio|  
|![CodeLens &#45; Icona di modifica da branch peer](~/docs/ide/media/codelensbranchpeericon.png "CodeLensBranchPeerIcon")|Branch peer|  
|![CodeLens &#45; Icona di modifica da branch più lontano ](~/docs/ide/media/codelensbranchfurtherawayicon.png "CodeLensBranchFurtherAwayIcon")|Branch più lontano rispetto a un branch padre, figlio o peer|  
|![CodeLens: icona di unione da branch padre](~/docs/ide/media/codelensbranchmergefromparenticon.png "CodeLensBranchMergeFromParentIcon")|Unione dal branch padre in un branch figlio|  
|![CodeLens: icona di unione da branch figlio](~/docs/ide/media/codelensbranchmergefromchildicon.png "CodeLensBranchMergeFromChildIcon")|Unione da un branch figlio nel branch padre|  
|![CodeLens: icona di unione da branch non correlato](~/docs/ide/media/codelensbranchmergefromunrelatedicon.png "CodeLensBranchMergeFromUnrelatedIcon")|Unione da un branch non correlato (unione senza base)|  
...
### <a name="contact-the-owner-of-an-item"></a>Contattare il proprietario di un elemento  
 ![Contattare il proprietario di un elemento](~/docs/ide/media/codelenscontactitemowner.png "CodeLensContactItemOwner")  
 ...
 ![Opzioni di contatto per un elemento](~/docs/ide/media/codelensitemcontactmenu.png "CodeLensItemContactMenu")  
...
3.  Se viene visualizzata un'icona di avviso ![CodeLens &#45; Avviso di unit test non ancora in esecuzione](~/docs/ide/media/codelenstestwarningicon.png "CodeLensTestWarningIcon"), eseguire i test.  
...
5.  Esaminare i risultati del test. Scegliere l'indicatore di stato dei test (![CodeLens &#45; Icona test non riuscito](~/docs/ide/media/codelenstestfailedicon.png "CodeLensTestFailedIcon") o ![CodeLens &#45; Icona unit test riuscito](~/docs/ide/media/codelenstestpassedicon.png "CodeLensTestPassedIcon")), oppure premere **ALT + 1**.  
 ...
 **R:**  È possibile attivare o disattivare tutti gli indicatori, ad eccezione di Riferimenti. Passare a **Strumenti**, **Opzioni**, **Editor di testo**, **Tutti i linguaggi**, **CodeLens**.  
 ...
 ![Attivare e disattivare gli indicatori a livello di file](~/docs/ide/media/codelensfilelevelonandoff.png "CodeLensFileLevelOnAndOff")  
 ...
 **R:** Sì, è possibile scegliere ![CodeLens &#45; Ancora come finestra](~/docs/ide/media/codelensdockwindow.png "CodeLensDockWindow") per ancorare CodeLens come una finestra.  
  
 ![Finestra Ancorare gli indicatori CodeLens](~/docs/ide/media/codelensselectdockwindow.png "CodeLensSelectDockWindow")  
  
 ![Finestra riferimenti CodeLens ancorata](~/docs/ide/media/codelensreferencesdockedwindow.png "CodeLensReferencesDockedWindow")  
