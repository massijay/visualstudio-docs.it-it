...
### <a name="dock-windows"></a>Ancorare le finestre  
 ...
 ![Guida a forma di rombo delle finestre dei documenti](~/docs/ide/media/documentwindowguidediamonds.png "Documentwindowguidediamonds")  
 ...
 ![Guide a forma di rombo delle finestre degli strumenti](~/docs/ide/media/vs10guidediamond.png "VS10GuideDiamond")  
 ...
 ![Ancoraggio di Esplora soluzioni in una nuova posizione](~/docs/ide/media/vs2015_dock_diamond.png "VS2017_Dock_diamond")  
...
### <a name="close-and-auto-hide-tool-windows"></a>Chiudere e nascondere automaticamente le finestre degli strumenti  
 ...
 ![Nascondi automaticamente](~/docs/ide/media/vs2015_auto_hide.png "vs2017_auto_hide")  
...
1.  Per rimuovere, rinominare o riordinare il layout personalizzato, scegliere **Finestra > Gestisci layout finestra**. Se si sposta un layout, l'associazione principale viene adattata automaticamente alla nuova posizione nell'elenco. Le associazioni non possono essere modificate diversamente, di conseguenza è possibile archiviare un massimo di 10 layout alla volta.  
     ...
     ![Gestisci layout finestra](~/docs/ide/media/managewindowlayouts.png "ManageWindowLayouts")  
