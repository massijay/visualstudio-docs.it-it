---
title: "Visualizzatore della Guida Microsoft | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
f1_keywords: 
  - "hv_general"
helpviewer_keywords: 
  - "Guida su Guida [Visualizzatore della Guida 2.0]"
  - "Help Viewer 2.0, esplorazione"
  - "Help Viewer 2.0, stampa di un argomento"
  - "Help Viewer 2.0, barra degli strumenti"
  - "Help Viewer 2.0, componenti della finestra"
  - "Guida di Microsoft Visualizzatore della Guida 2.0"
  - "stampa di un argomento [Visualizzatore della Guida 2.0]"
  - "barra degli strumenti [Visualizzatore della Guida 2.0]"
...
> [!WARNING]
>  Quando si installa Visual Studio, è possibile ottenere Help Viewer.  Per iniziare a leggere gli argomenti della Guida in Help Viewer anziché nel sito di download di MSDN, accedere al menu **Guida** di Visual Studio, selezionare **Imposta preferenza Guida** e quindi selezionare **Avvia in Help Viewer**.  Gli argomenti di aiuto della guida non in linea per una data versione di Visual Studio sono disponibili solo dopo il rilascio finale di tale versione.  
...
## Vedere anche  
 ...
 [Risoluzione dei problemi relativi al visualizzatore della Guida](../ide/troubleshooting-the-help-viewer.md)