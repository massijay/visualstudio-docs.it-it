...
2.  Aggiungere il codice seguente dopo il commento "Completare il problema di sottrazione".  
     ...
     ![Descrizione comando della finestra di IntelliSense](~/docs/ide/media/express_overloads.png "Express\_Overloads")  
Descrizione comando della finestra di IntelliSense  
     ...
     ![Overload per il metodo Next&#40;&#41; in IntelliSense](~/docs/ide/media/express_nextoverload.png "Express\_NextOverload")  
