---
title: "Tasti di scelta rapida (visualizzatore della Guida) | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
ms.topic: "article"
helpviewer_keywords: 
  - "Visualizzatore della Guida 2.0, tasti di scelta rapida"
  - "tasti di scelta rapida [Visualizzatore della Guida 2.0]"
...
---
# Tasti di scelta rapida (visualizzatore della Guida)
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

È possibile spostarsi nel Visualizzatore della Guida Microsoft utilizzando i tasti di scelta rapida della tabella seguente:  
  
|Area|Sequenza di tasti|Azione|  
|----------|-----------------------|------------|  
|Applicazione generale|Spazio|Da utilizzare al posto di Invio ovunque ad eccezione dei campi di modifica.|  
...
|Barra degli strumenti|CTRL\+F|Visualizzare la barra di ricerca nell'area dell'argomento da utilizzare per cercare del testo nell'argomento corrente.|  
...
|Barra degli strumenti|CTRL\+O|Visualizza la finestra di dialogo **Opzioni visualizzatore**.|  
...
|Strumenti di spostamento|ALT\+F<br /><br /> \-oppure\-<br /><br /> CTRL \+ MAIUSC \+ F|Visualizza la scheda **Preferiti**.|  
...
|Argomento|Menu di scelta rapida<br /><br /> OR<br /><br /> MAIUSC \+ F10|Visualizzare il menu di scelta rapida per l'elemento corrente dell'interfaccia utente.|  
...
|Opzioni di visualizzazione|ALT\+O|Selezionare o deselezionare la casella di controllo **Connetti per verificare la disponibilità di aggiornamenti**.|  
