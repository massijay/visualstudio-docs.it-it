...
3.  Nella finestra di dialogo **Nuova configurazione soluzione** assegnare un nome alla nuova configurazione `Test`, copiare le impostazioni dalla configurazione per il debug esistente e quindi scegliere il pulsante **OK**.  
     ...
     ![Finestra di dialogo Nuova configurazione soluzione](~/docs/ide/media/buildwalk_newsolutionconfigdlgbox.png "BuildWalk_NewSolutionConfigDlgBox")  
...
5.  Nella finestra di dialogo **Nuova piattaforma soluzione** scegliere **x64** e non copiare le impostazioni dalla piattaforma x86.  
     ...
     ![Finestra di dialogo Nuova piattaforma soluzione](~/docs/ide/media/buildwalk_newsolutionplatform.png "BuildWalk_NewSolutionPlatform")  
...
-   Nella barra dei menu scegliere **Compilazione**, **Compila soluzione**.  
 ...
 ![Finestra Output di Visual Basic ](~/docs/ide/media/buildwalk_vbbuildoutputwnd.png "BuildWalk_VBBuildOutputWnd")  
...
4.  Compilare la soluzione.  
 ...
 ![Finestra Output, avvisi durante la compilazione di Visual Basic ](~/docs/ide/media/buildwalk_visualbasicbuildwarnings.png "BuildWalk_VisualBasicBuildWarnings")  
