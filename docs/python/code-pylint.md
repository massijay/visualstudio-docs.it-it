...
![Comando PyLint nel menu di scelta rapida per i progetti Python](~/docs/python/media/code-pylint-command.png)
...
![Elenco errori di PyLint](~/docs/python/media/code-pylint-error-list.png)
