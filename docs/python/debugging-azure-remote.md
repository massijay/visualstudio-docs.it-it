...
![Abilitazione di WebSocket nel portale di Azure](~/python/media/azure-remote-debugging-enable-web-sockets.png)
...
![Debug di un sito Web di Servizio app di Azure](~/python/media/azure-remote-debugging-attached.png)
...
![Pagina di informazioni sul proxy per il debug remoto in Azure](~/python/media/azure-remote-debugging-proxy-info-page.png)
...
![Determinazione dell'endpoint del debugger in Servizio app di Azure](~/python/media/azure-remote-debugging-secret.png)
...
![Uso della finestra di dialogo Connetti a processo per collegarsi a un sito Web di Azure](~/python/media/azure-remote-debugging-manual-attach.png)
