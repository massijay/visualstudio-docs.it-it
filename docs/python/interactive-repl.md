...
![Finestra interattiva di Python](~/python/media/interactive-window.png)
...
![Collegamento Finestra interattiva nella finestra Ambienti Python](~/python/media/interactive-window-opening.png)
...
![Voci di menu relative alla finestra interattiva in Visualizza > Altre finestre](~/python/media/interactive-window-menu.png)
...
![Menu Esegui progetto in Python interattivo](~/python/media/interactive-execute-project.png)
...
![Ambiti della finestra interattiva](~/python/media/interactive-scopes.png)
...
![Finestra interattiva nell'ambito importlib](~/python/media/interactive-importlib-scope.png)
...
![Comando di menu Invia a finestra interattiva](~/python/media/interactive-send-to.png)
