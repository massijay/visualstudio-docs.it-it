...
![Completamento dei membri](~/python/media/code-editing-completions-simple.png)
...
![Completamento dei membri con filtro](~/python/media/code-editing-completion-filtering.png)
...
![Completamento dei membri per più tipi](~/python/media/code-editing-completion-types.png)
...
![Completamento dei membri privati](~/python/media/code-editing-completion-dunder.png)
...
![Completamento per le importazioni](~/python/media/code-editing-completion-import.png)
...
![Completamento per le eccezioni](~/python/media/code-editing-completion-exception.png)
...
![Completamento per gli elementi Decorator](~/python/media/code-editing-completion-decorator.png)
...
![Informazioni della Guida per le firme](~/python/media/code-editing-signature-help.png)
...
![Informazioni rapide](~/python/media/code-editing-quick-info.png)
...
![Colorazione del codice](~/python/media/code-editing-code-coloring.png)
...
![Opzioni Tipi di carattere e colori](~/python/media/code-editing-customize-colors.png)
...
![Frammenti di codice](~/python/media/code-editing-code-snippets.png)
...
![Gestione frammenti di codice](~/python/media/code-editing-code-snippets-manager.png)
...
![Barra di spostamento](~/python/media/code-editing-navigation-bar.png)
...
![Vai a definizione](~/python/media/code-editing-go-to-definition.png)
...
![Passa a](~/python/media/code-editing-navigate-to.png)
...
![Risultati di Trova tutti i riferimenti](~/python/media/code-editing-find-all-references.png)
