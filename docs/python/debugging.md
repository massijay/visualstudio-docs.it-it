...
![Punti di interruzione in Visual Studio](~/docs/python/media/debugging-breakpoints.png)
...
![Creazione di un punto di analisi con un punto di interruzione](~/docs/python/media/debugging-tracepoint.png)
...
![Suggerimenti dati nel debugger](~/docs/python/media/debugging-quick-tips.png)
...
![Finestra Auto nel debugger](~/docs/python/media/debugging-autos-window.png)
...
![Finestra Variabili locali nel debugger](~/docs/python/media/debugging-locals-window.png)
...
![Finestra Espressioni di controllo nel debugger](~/docs/python/media/debugging-watch-window.png)
...
![Visualizzatori di stringa](~/docs/python/media/debugging-string-visualizers.png)
...
![Popup dell'eccezione](~/docs/python/media/debugging-exception-popup.png)
...
![Finestra Eccezioni](~/docs/python/media/debugging-exception-settings.png)
...
![Proprietà di debug del progetto](~/docs/python/media/debugging-project-properties.png)
...
![Finestra Debug interattivo Python](~/docs/python/media/debugging-interactive.png)
...
![Opzioni della finestra Debug interattivo](~/docs/python/media/debugging-interactive-options.png)
