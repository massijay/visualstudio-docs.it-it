...
Quando si installa Visual Studio 2017 da un prompt dei comandi è possibile usare i seguenti parametri della riga di comando, detti anche opzioni.  
...
| ```--lang <language-locale>``` *[&#60;language-locale&#62; ...]* | **Facoltativa**: consente di installare o disinstallare pacchetti di risorse con le lingue specificate. Per altre informazioni, vedere la sezione [Elenco delle impostazioni locali delle lingue](#list-of-language-locales) in questa pagina.|
...
Per un elenco di ID di componenti e carichi di lavoro ordinati per prodotto Visual Studio, vedere la pagina [Visual Studio 2017 Workload and Component IDs](workload-and-component-ids.md) (ID di carichi di lavoro e componenti di Visual Studio 2017).
