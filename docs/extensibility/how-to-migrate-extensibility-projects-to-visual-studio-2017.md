...
![Strumenti di compilazione VSSDK](~/docs/extensibility/media/vssdk-build-tools.png)
...
* Selezionare **prerequisiti** scheda e premere **New** pulsante.
  ...
  ![Progettazione manifesto VSIX](~/docs/extensibility/media/vsix-manifest-designer.png)

* Il **aggiungere nuovi prerequisiti** aprirà la finestra.

  ![aggiungere il prerequisito vsix](~/docs/extensibility/media/add-vsix-prerequisite.png)
...
* Aggiornare la versione, se necessario.
  ...
  ![aggiungere il prerequisito di roslyn](~/docs/extensibility/media/add-roslyn-prerequisite.png)
...
![Avvia programma esterno](~/docs/extensibility/media/start-external-program.png)
...
![Programma di installazione VSIX in Visual Studio 2017](~/docs/extensibility/media/vsixinstaller-vs-2017.png)
...
![processi in esecuzione Visual Studio](~/docs/extensibility/media/vs-running-processes.png)
...
![Prerequisito mancante vsixinstaller](~/docs/extensibility/media/vsixinstaller-missing-prerequisite.png)
