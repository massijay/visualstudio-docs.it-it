---
title: IDebugBoundBreakpoint2::GetPendingBreakpoint | Documenti di Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
#### <a name="parameters"></a>Parametri  
 `ppPendingBreakpoint`  
 [out] Restituisce il [IDebugPendingBreakpoint2](../../../extensibility/debugger/reference/idebugpendingbreakpoint2.md) oggetto che rappresenta il punto di interruzione in sospeso che è stato usato per creare questa associazione punto di interruzione.  
