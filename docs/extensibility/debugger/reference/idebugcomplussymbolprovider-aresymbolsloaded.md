---
title: IDebugComPlusSymbolProvider::AreSymbolsLoaded | Documenti di Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Determina se vengono caricati i simboli di debug per il modulo specificato dato l'identificatore di dominio di applicazione.  
