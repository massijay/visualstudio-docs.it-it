# [Riferimenti (API di debug di Visual Studio)](reference-visual-studio-debugging-apis.md)
...
### [Enumerazioni (debug di Visual Studio)](enumerations-visual-studio-debugging.md)
