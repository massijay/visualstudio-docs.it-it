---
title: GUID IDE | Documenti di Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
La <xref:Microsoft.VisualStudio.VSConstants>classe pubblica i GUID di alcune parti dell'ambiente di sviluppo integrato (IDE) come indicato nella tabella riportata di seguito.</xref:Microsoft.VisualStudio.VSConstants>  
...
## <a name="files-virtual-and-physical-folders-and-subprojects"></a>File, cartelle virtuali e fisiche e dei relativi sottoprogetti  
...
## <a name="component-selector-page-guids"></a>Componente selettore pagina GUID  
...
## <a name="miscellaneous-shell-guids"></a>GUID varie Shell  
