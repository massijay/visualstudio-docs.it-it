...
helpviewer_keywords: 
  - "<LocationFieldMRUPrefix> (elemento) [modelli di Visual Studio]"
  - "LocationFieldMRUPrefix (elemento) [modelli di Visual Studio]"
...
---
# Elemento LocationFieldMRUPrefix (modelli di Visual Studio)
[!INCLUDE[vs2017banner](../code-quality/includes/vs2017banner.md)]

Specifica i percorsi utilizzati di recente \(MRU, most recently used\) nella finestra di dialogo **Nuovo progetto** e **Aggiungi nuovo elemento**.  
...
## Note  
 Questo elemento deve essere utilizzato solo per modelli creati tramite [!INCLUDE[vsipprvsip](../extensibility/includes/vsipprvsip_md.md)].  
