...
# [Creare l'estensione della prima: Hello World](extensibility-hello-world.md)
...
## [Caricamento leggero soluzioni](lightweight-solution-load-extension-impact.md)
...
# [Procedura: round trip estensioni per Visual Studio](how-to-roundtrip-VSIXs.md)
...
#### [Elemento VSIXLanguagePack (schema del Language Pack VSIX)](vsixlanguagepack-element-vsix-language-pack-schema.md)
##### [Elemento LocalizedName (schema del Language Pack VSIX)](localizedname-element-vsix-language-pack-schema.md)
##### [Elemento LocalizedDescription (schema del Language Pack VSIX)](localizeddescription-element-vsix-language-pack-schema.md)
##### [Elemento MoreInfoURL (schema del Language Pack VSIX)](moreinfourl-element-vsix-language-pack-schema.md)
##### [Elemento License (schema del Language Pack VSIX)](license-element-vsix-language-pack-schema.md)
