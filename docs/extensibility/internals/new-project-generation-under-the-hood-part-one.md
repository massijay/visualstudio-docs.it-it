...
## La finestra di dialogo Nuovo progetto  
 ...
 ![Finestra di dialogo Nuovo progetto](~/docs/extensibility/internals/media/newproject.gif "NewProject")  
...
#### I nodi figlio di tipo di progetto e i file .vstdir  
 ...
 ![Tipi di progetto](~/docs/extensibility/internals/media/projecttypes.png "ProjectTypes")  
  
 Nella cartella ProjectTemplates corrispondente è simile al seguente:  
  
 ![Modelli di progetto](~/docs/extensibility/internals/media/projecttemplates.png "ProjectTemplates")  
