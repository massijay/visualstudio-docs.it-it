...
![Controllo pulsante con linea rossa](~/docs/extensibility/ux-guidelines/media/0303-155_buttoncontrolredline.png "0303 155_ButtonControlRedline")
...
![Pulsante standard](~/docs/extensibility/ux-guidelines/media/03.03.Button.Standard.png "03.03.Button.Standard")<br />Pulsante standard
...
![Pulsante predefinito](~/docs/extensibility/ux-guidelines/media/03.03.Button.Default.png "03.03.Button.Default")<br />Pulsante predefinito
...
![Pulsante disabilitato](~/docs/extensibility/ux-guidelines/media/03.03.Button.Disabled.png "03.03.Button.Disabled")<br />Pulsante disabilitato  
...
![Pulsante al passaggio del mouse](~/docs/extensibility/ux-guidelines/media/03.03.Button.hover.png "03.03.Button.hover")<br />Pulsante al passaggio del mouse  
...
![Pulsante premuto](~/docs/extensibility/ux-guidelines/media/03.03.Button.Pressed.png "03.03.Button.Pressed")<br />Pulsante premuto  
...
![Pulsante con stato attivo](~/docs/extensibility/ux-guidelines/media/03.03.Button.Focused.png "03.03.Button.Focused")<br />Pulsante con stato attivo  
...
![Casella di controllo (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-161_checkboxredline.png "0303-161_CheckboxRedline")<br />Casella di controllo (con linea rossa)  
...
![Casella di riepilogo o combinata a discesa predefinito](~/docs/extensibility/ux-guidelines/media/0303-168_dropdowncombobox.png "0303-168_DropDownComboBox")<br />Casella di riepilogo o combinata a discesa predefinito
...
![Casella di riepilogo o combinata a discesa disabilitata](~/docs/extensibility/ux-guidelines/media/0303-169_dropdowncomboboxdisabled.png "0303-169_DropDownComboBoxDisabled")<br />Casella di riepilogo o combinata a discesa disabilitata
...
**Elenchi a discesa e combinata le finestre di visualizzazione elemento elenco: stati**  
 ...
 ![Casella di riepilogo o combinata a discesa premuto visualizzazione elemento elenco](~/docs/extensibility/ux-guidelines/media/0303-174_dropdowncomboboxlistview.png "0303-174_DropDownComboBoxListView")<br />Casella di riepilogo o combinata a discesa premuto visualizzazione elemento elenco  
...
![Controllo dati tabulari o griglia (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-197_tabulardatagridcontrolredline.png "0303-197_TabularDataGridControlRedline")<br />Controllo dati tabulari o griglia (con linea rossa)
...
![Testo informativo predefinito](~/docs/extensibility/ux-guidelines/media/0303_InstructionalText.png "0303_InstructionalText.png")<br />Testo informativo predefinito
...
![Testo esplicativo secondario](~/docs/extensibility/ux-guidelines/media/0303_SecondaryInstructionalText.png "0303_SecondaryInstructionalText.png")<br />Testo esplicativo secondario
...
![Testo di suggerimento predefinito](~/docs/extensibility/ux-guidelines/media/0303_HintText.png "0303_HintText.png")<br />Testo di suggerimento predefinito
...
![Testo di suggerimento obbligatorio](~/docs/extensibility/ux-guidelines/media/0303_RequiredHintText.png "0303_RequiredHintText.png")<br />Testo di suggerimento obbligatorio
...
![Testo di controllo casella di ricerca](~/docs/extensibility/ux-guidelines/media/0303_SearchBoxControl.png "0303_SearchBoxControl.png")<br />Testo di controllo casella di ricerca
...
![Collegamento ipertestuale disabilitato](~/docs/extensibility/ux-guidelines/media/0303-137_hyperlinkdisabled.png "0303-137_HyperlinkDisabled")<br />Collegamento ipertestuale disabilitato  
...
![Barra informazioni (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-138_infobarredline.png "0303-138_InfobarRedline")<br />Barra informazioni (con linea rossa)
...
![Barra informazioni predefinito](~/docs/extensibility/ux-guidelines/media/0303-139_infobar.png "0303-139_Infobar")<br />Barra informazioni predefinito
...
![Barra informazioni chiudere predefinito (&times;) pulsante](~/docs/extensibility/ux-guidelines/media/0303_InfobarCloseDefault.png "0303_InfobarCloseDefault.png")<br />Barra informazioni chiudere predefinito (&times;) pulsante
...
![Barra informazioni Close (&times;) pulsante al passaggio del mouse](~/docs/extensibility/ux-guidelines/media/0303_InfobarCloseHover.png "0303_InfobarCloseHover.png")<br />Barra informazioni Close (&times;) pulsante al passaggio del mouse
...
![Barra informazioni chiudere premuto (&times;) pulsante](~/docs/extensibility/ux-guidelines/media/0303_InfobarClosePressed.png "0303_InfobarClosePressed.png")<br />Barra informazioni chiudere premuto (&times;) pulsante
...
![Pulsante di collegamento ipertestuale predefinito barra informazioni](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkButtonDefault.png "0303_InfobarHyperlinkButtonDefault.png")<br />Pulsante di collegamento ipertestuale predefinito barra informazioni
...
![Barra informazioni pulsante di collegamento ipertestuale al passaggio del mouse](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkButtonHover.png "0303_InfobarHyperlinkButtonHover.png")<br />Barra informazioni pulsante di collegamento ipertestuale al passaggio del mouse
...
![Pulsante premuto barra informazioni](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkButtonPressed.png "0303_InfobarHyperlinkButtonPressed.png")<br />Pulsante premuto barra informazioni
...
![Pulsante di collegamento ipertestuale predefinito inline barra informazioni](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkButtonDefault.png "0303_InfobarHyperlinkButtonDefault.png")<br />Pulsante di collegamento ipertestuale predefinito inline barra informazioni
...
![Pulsante di collegamento ipertestuale incorporato barra informazioni al passaggio del mouse](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkInlineHover.png "0303_InfobarHyperlinkInlineHover.png")<br />Pulsante di collegamento ipertestuale incorporato barra informazioni al passaggio del mouse
...
![Barra informazioni in linea un collegamento ipertestuale pulsante selezionato](~/docs/extensibility/ux-guidelines/media/0303_InfobarHyperlinkInlinePressed.png "0303_InfobarHyperlinkInlinePressed.png")<br />Barra informazioni in linea un collegamento ipertestuale pulsante selezionato
...
![Pulsante barra informazioni predefinito](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonDefault.png "0303_InfobarButtonDefault.png")<br />Pulsante barra informazioni predefinito
...
![Pulsante al passaggio del mouse sulla barra informazioni](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonHover.png "0303_InfobarButtonHover.png")<br />Pulsante al passaggio del mouse sulla barra informazioni
...
![Pulsante premuto barra informazioni](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonPressed.png "0303_InfobarButtonPressed.png")<br />Pulsante premuto barra informazioni
...
![Pulsante disabilitato barra informazioni](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonDisabled.png "0303_InfobarButtonDisabled.png")<br />Pulsante disabilitato barra informazioni
...
![Pulsante con stato attivo sulla barra informazioni](~/docs/extensibility/ux-guidelines/media/0303_InfobarButtonFocus.png "0303_InfobarButtonFocus.png")<br />Pulsante con stato attivo sulla barra informazioni
...
![Barra di scorrimento (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-140_scrollbarredline.png "0303-140_ScrollbarRedline")<br />Barra di scorrimento (con linea rossa)
...
![Freccia della barra di scorrimento predefinito](~/docs/extensibility/ux-guidelines/media/0303-142_scrollbararrow.png "0303-142_ScrollbarArrow")<br />Freccia della barra di scorrimento predefinito
...
![Campo di input di ricerca con stato non attivo e inattivo](~/docs/extensibility/ux-guidelines/media/0303-114-1_searchinputfieldunfocusedinactive.png "0303-114-1_SearchInputFieldUnfocusedInactive")<br />Campo di input di ricerca con stato non attivo e inattivo  
...
![Pulsante di menu a discesa di ricerca con stato non attivo](~/docs/extensibility/ux-guidelines/media/0303-116_searchdropdownbuttonunfocused.png "0303-116_SearchDropdownButtonUnfocused")<br />Pulsante di menu a discesa di ricerca con stato non attivo
...
![Opzioni di ricerca](~/docs/extensibility/ux-guidelines/media/0303-127_searchoptions.png "0303-127_SearchOptions")<br />Opzioni di ricerca predefinite (collegamento)  
...
![Premuto opzioni di ricerca (casella di controllo)](~/docs/extensibility/ux-guidelines/media/0303-131_searchsuggestedpressed.png "0303-131_SearchSuggestedPressed")<br />Premuto opzioni di ricerca (casella di controllo)   
...
![Elemento della visualizzazione albero al passaggio del mouse](~/docs/extensibility/ux-guidelines/media/0303-149_treeviewhover.png "0303-149_TreeViewHover")<br />Elemento della visualizzazione albero al passaggio del mouse
...
![Elemento della visualizzazione albero con stato attivo e selezionato al passaggio del mouse](~/docs/extensibility/ux-guidelines/media/0303-153_treeviewfocusedhover.png "0303-153_TreeViewFocusedHover")<br />Elemento della visualizzazione albero con stato attivo e selezionato al passaggio del mouse  
...
![Elemento della visualizzazione albero con stato non attivo e selezionato al passaggio del mouse](~/docs/extensibility/ux-guidelines/media/0303-154_treeviewunfocusedhover.png "0303-154_TreeViewUnfocusedHover")<br />Elemento della visualizzazione albero con stato non attivo e selezionato al passaggio del mouse  
...
![Scaffale dei comandi di Visual Studio (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-188_commandshelfredline.png "0303-188_CommandShelfRedline")<br />Scaffale dei comandi di Visual Studio (con linea rossa)  
...
![Voci di menu con linea rossa](~/docs/extensibility/ux-guidelines/media/0303-009_menuitemredline.png "0303 009_MenuItemRedline")  
...
![Voci di menu predefinito](~/docs/extensibility/ux-guidelines/media/0303-010_menudefault.png "0303-010_MenuDefault")<br />Voci di menu predefinito  
...
![Menu selezionato](~/docs/extensibility/ux-guidelines/media/0303-012_menuselected.png "0303-012_MenuSelected")<br />Voce di menu selezionata    
...
![Icona del comando predefinita](~/docs/extensibility/ux-guidelines/media/0303-023_commandicondefault.png "0303-023_CommandIconDefault")<br />Icona del comando predefinita
...
![Campo input casella combinata barra dei comandi](~/docs/extensibility/ux-guidelines/media/0303-030_comboboxinputfield.png "0303-030_ComboBoxInputField")<br />Campo input casella combinata barra dei comandi  
...
![Elenco elenco a discesa sulla barra dei comandi](~/docs/extensibility/ux-guidelines/media/0303-032_comboboxdropdownlist.png "0303-032_ComboBoxDropdownList")<br />Elenco elenco a discesa sulla barra dei comandi
...
![Pulsante di comando della barra dei menu a discesa al passaggio del mouse](~/docs/extensibility/ux-guidelines/media/0303-047_dropdownbuttonhover.png "0303-047_DropdownButtonHover")<br />Pulsante di comando della barra dei menu a discesa al passaggio del mouse  
...
![Nella barra dei pulsante 'Opzioni' al passaggio del mouse](../../extensibility/ux-guidelines/media/0303-061_moreoptionshover.png "0303-061_MoreOptionsHover")<br />Nella barra dei pulsante 'Opzioni' al passaggio del mouse  
...
![Impostazione predefinita con stato attivo, a virgola mobile cornice della finestra di documento](~/docs/extensibility/ux-guidelines/media/0303-067_framefocused.png "0303-067_FrameFocused")<br />Impostazione predefinita con stato attivo, a virgola mobile cornice della finestra di documento
...
![Scheda documento aperto (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-073_opendocumenttabredline.png "0303-073_OpenDocumentTabRedline")<br />Scheda documento aperto (con linea rossa)
...
![Scheda documento selezionata, con stato attivo](../../extensibility/ux-guidelines/media/0303-074_selectedtabfocused.png "0303-074_SelectedTabFocused")<br />Scheda documento selezionata, con stato attivo
...
![Scheda anteprima selezionata, con stato non attivo](~/docs/extensibility/ux-guidelines/media/0303-080_previewtabunfocused.png "0303-080_PreviewTabUnfocused")<br />Scheda anteprima selezionata, con stato non attivo
...
![Assegnazione di tag in Visual Studio (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-176_taggingredline.png "0303-176_TaggingRedline")<br />Assegnazione di tag in Visual Studio (con linea rossa)  
...
![Tag predefinito](~/docs/extensibility/ux-guidelines/media/0303-177_tag.png "0303-177_Tag")<br />Tag predefinito
...
![Tag selezionato](~/docs/extensibility/ux-guidelines/media/0303-180_tagselected.png "0303-180_TagSelected")<br />Tag selezionato  
...
![Chiudi premuto (&times;) tag glifo](~/docs/extensibility/ux-guidelines/media/0303-183_tagglyphpressed.png "0303-183_TagGlyphPressed")<br />Chiudi premuto (&times;) tag glifo
...
![Mobile, finestra degli strumenti con stato non attivo](../../extensibility/ux-guidelines/media/0303-091_toolwindowunfocused.png "0303-091_ToolWindowUnfocused")<br />Mobile, finestra degli strumenti con stato non attivo  
...
![Finestra Casella degli strumenti simili (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-189_toolboxredline.png "0303-189_ToolboxRedline")<br />Finestra Casella degli strumenti simili (con linea rossa)
...
![Nodo padre di casella degli strumenti predefinita](../../extensibility/ux-guidelines/media/0303-190_toolboxparentnode.png "0303-190_ToolboxParentNode")<br />Nodo padre di casella degli strumenti predefinita

![Nodo figlio della casella degli strumenti predefinito](../../extensibility/ux-guidelines/media/0303-191_toolboxchildnode.png "0303-191_ToolboxChildNode")<br />Nodo figlio della casella degli strumenti predefinito
...
![Nodo figlio della casella degli strumenti selezionata, con stato non attivo](~/docs/extensibility/ux-guidelines/media/0303-196_toolboxchildnodeunfocused.png "0303-196_ToolboxChildNodeUnfocused")<br />Nodo figlio della casella degli strumenti selezionata, con stato non attivo  
...
![Barra del titolo con stato non attivo](~/docs/extensibility/ux-guidelines/media/0303-094_titlebarunfocused.png "0303-094_TitleBarUnfocused")<br />Barra del titolo con stato non attivo
...
![Title bar pulsante (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-095_titlebarbuttonredline.png "0303-095_TitleBarButtonRedline")<br />Title bar pulsante (con linea rossa)  

| Usare... | Non usare... |
| --- | --- |
| ... per i pulsanti visualizzati nell'interfaccia utente che utilizza il token di colore dalle barre del titolo della finestra dello strumento. | ... per i pulsanti visualizzati in altre posizioni. |
| | ... in qualsiasi combinazione sfondo/primo piano diversa da quella specificata. |

**Con stato attivo di pulsanti della barra del titolo: stato predefinito**

![Impostazione predefinita, i pulsanti della barra del titolo con stato attivo](../../extensibility/ux-guidelines/media/0303-096_titlebarbuttonfocused.png "0303-096_TitleBarButtonFocused")<br />Impostazione predefinita, i pulsanti della barra del titolo con stato attivo  
...
![Impostazione predefinita, i pulsanti della barra del titolo con stato non attivo](~/docs/extensibility/ux-guidelines/media/0303-097_titlebarbuttonunfocused.png "0303-097_TitleBarButtonUnfocused")<br />Impostazione predefinita, i pulsanti della barra del titolo con stato non attivo    
...
![Pulsanti della barra del titolo con stato attivo su premere](../../extensibility/ux-guidelines/media/0303-100_titlebarbuttonfocusedpressed.png "0303-100_TitleBarButtonFocusedPressed")<br />Pulsanti della barra del titolo con stato attivo su premere
...
![Scheda della finestra degli strumenti con stato non attivo selezionata](~/docs/extensibility/ux-guidelines/media/0303-104_toolwindowtabunfocused.png "0303-104_ToolWindowTabUnfocused")<br />Scheda della finestra degli strumenti con stato non attivo selezionata
...
![Scheda finestra degli strumenti di sfondo predefinito](~/docs/extensibility/ux-guidelines/media/0303-105_toolwindowbackgroundtab.png "0303-105_ToolWindowBackgroundTab")<br />Scheda finestra degli strumenti di sfondo predefinito  
...
![Schede Nascondi automaticamente (con linea rossa)](~/docs/extensibility/ux-guidelines/media/0303-107_autohideredline.png "0303 107_AutoHideRedline")schede Nascondi automaticamente (con linea rossa)
