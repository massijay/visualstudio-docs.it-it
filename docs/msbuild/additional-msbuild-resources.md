...
Se le informazioni necessarie per risolvere un problema non sono disponibili nella documentazione, è possibile consultare altre risorse, come gli articoli della Knowledge Base, la community degli sviluppatori o il supporto tecnico.  
  
## Articoli di Microsoft Knowledge Base  
 È possibile cercare nella Knowledge Base \(KB\) online articoli relativi ai problemi dei prodotti.  La Knowledge Base non contiene articoli per tutti i problemi, tuttavia gli errori riscontrati da un numero significativo di utenti sono in genere documentati.  È possibile accedere agli articoli della Knowledge Base sul sito Web della [Knowledge Base \(risultati di ricerca di MSBuild\)](http://search.microsoft.com/supportresults.aspx?q=knowledge+base+MSBuild&x=0&y=0).  
  
## Forum della community  
 Nei forum è possibile interagire con altri sviluppatori, nonché con dipendenti Microsoft.  Se si riscontra un errore per cui non si è in grado di trovare una risoluzione, si possono pubblicare domande relative a tale problema in un forum.  È inoltre possibile eseguire ricerche nei newsgroup per verificare se altri utenti hanno inserito messaggi sullo stesso problema.  È possibile accedere al forum di Visual Studio MSBuild sul sito Web [Forum MSDN](http://go.microsoft.com/fwlink/?LinkId=48931).  
...
## Supporto tecnico  
 Se le risorse disponibili non sono sufficienti per ottenere una risposta alle proprie domande, è possibile contattare il servizio di Supporto tecnico Microsoft visitando il sito Web [Supporto tecnico Microsoft](http://go.microsoft.com/fwlink/?linkid=1782).  Per informazioni sul supporto tecnico disponibile nella propria area, vedere [Comunicazioni con Microsoft](../ide/talk-to-us.md).  
