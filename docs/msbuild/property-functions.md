...
##  <a name="a-namebkmksyntaxa-property-function-syntax"></a><a name="BKMK_Syntax"></a> Sintassi delle funzioni di proprietà  
...
###  <a name="a-namebkmkstringa-string-property-functions"></a><a name="BKMK_String"></a> Funzioni di proprietà stringa  
...
###  <a name="a-namebkmkstatica-static-property-functions"></a><a name="BKMK_Static"></a> Funzioni di proprietà statiche  
...
###  <a name="a-namebkmkinstancemethodsa-calling-instance-methods-on-static-properties"></a><a name="BKMK_InstanceMethods"></a> Chiamata di metodi di istanza su proprietà statiche  
...
###  <a name="a-namebkmkpropertyfunctionsa-msbuild-property-functions"></a><a name="BKMK_PropertyFunctions"></a> Funzioni di proprietà MSBuild  
...
##  <a name="a-namebkmknesteda-nested-property-functions"></a><a name="BKMK_Nested"></a> Funzioni di proprietà annidate  
