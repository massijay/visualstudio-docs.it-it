...
|`OutputAssembly`|Parametro di output <xref:Microsoft.Build.Framework.ITaskItem> obbligatorio.<br /><br /> Specifica il nome del file generato dall'attività. Questo parametro corrisponde all'opzione `/out` di [Al.exe (Assembly Linker)](http://msdn.microsoft.com/Library/b5382965-0053-47cf-b92f-862860275a01).|  
