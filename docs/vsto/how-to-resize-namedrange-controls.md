---
title: "Procedura: Ridimensionare i controlli NamedRange | Microsoft Docs"
ms.custom: ""
ms.date: "02/02/2017"
...
helpviewer_keywords: 
  ...
  - "NamedRange (controllo), ridimensionamento"
  - "intervalli, ridimensionamento in Excel"
...
##  <a name="designtime"></a> Ridimensionamento di controlli NamedRange in fase di progettazione  
...
##  <a name="runtimedoclevel"></a> Ridimensionamento di controlli NamedRange in fase di esecuzione in un progetto a livello di documento  
...
##  <a name="runtimeaddin"></a> Ridimensionamento di controlli NamedRange in fase di esecuzione in un progetto di componente aggiuntivo VSTO  
