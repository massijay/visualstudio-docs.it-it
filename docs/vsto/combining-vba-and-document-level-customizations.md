...
helpviewer_keywords: 
  ...
  - "VBA [sviluppo per Office in Visual Studio]"
  - "documenti di Office [sviluppo per Office in Visual Studio], Visual Basic, Applications Edition"
  - "VBA [sviluppo per Office in Visual Studio], informazioni su VBA e le personalizzazioni a livello di documento"
  - "codice gestito [sviluppo per Office in Visual Studio], Visual Basic, Applications Edition"
  - "personalizzazioni a livello di documento [sviluppo per Office in Visual Studio], Visual Basic, Applications Edition"
...
> [!NOTE]  
>  Per informazioni sull'uso della variabile globale `missing` al posto di parametri facoltativi in Visual C\#, vedere [Scrittura di codice nelle soluzioni Office](../vsto/writing-code-in-office-solutions.md).  
...
## Consentire al codice VBA di essere chiamato nell'assembly di personalizzazione  
...
## Uso dei membri nel codice VBA per eseguire chiamate nell'assembly di personalizzazione  
...
### Uso della proprietà CallVSTOAssembly in un progetto Visual Basic  
...
### Uso del metodo GetManagedClass  
