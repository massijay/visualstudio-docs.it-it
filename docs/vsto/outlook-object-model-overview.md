...
# Panoramica del modello a oggetti di Outlook
 ...
 ![Collegamento a video](~/docs/data-tools/media/playvideo.gif "Collegamento a video") Per una dimostrazione correlata, vedere il video su [come usare Outlook per creare una relazione attività personalizzata](http://go.microsoft.com/fwlink/?LinkID=130315).  
