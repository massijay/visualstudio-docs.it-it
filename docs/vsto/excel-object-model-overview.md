...
-   <xref:Microsoft.Office.Interop.Excel.Range>  
 ...
 ![Collegamento a video](~/docs/data-tools/media/playvideo.gif "Collegamento a video") Per una dimostrazione video correlata, vedere [Ricerca per categorie: utilizzare i gestori eventi in un componente aggiuntivo Excel 2007](http://go.microsoft.com/fwlink/?LinkID=130291) e [Ricerca per categorie: utilizzare le forme per creare un grafico a bolle in Excel](http://go.microsoft.com/fwlink/?LinkID=130313).  
