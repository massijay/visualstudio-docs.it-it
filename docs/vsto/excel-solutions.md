...
##  <a name="applevel"></a> Sviluppo di componenti aggiuntivi VSTO per Excel  
 ...
 ![Collegamento a video](../vsto/media/playvideo.png "Collegamento a video") Per una dimostrazione video correlata, vedere la [procedura per automatizzare PowerPoint da un componente aggiuntivo di Excel](http://go.microsoft.com/fwlink/?LinkID=130300).  
