...
##  <a name="separateassemblies"></a> Separare gli assembly di interoperabilità primari per la compilazione e l'esecuzione di progetti  
...
##  <a name="usingfeatures"></a> Uso delle funzionalità di più applicazioni di Microsoft Office in un unico progetto  
...
|Libreria dei tipi di Microsoft Smart Tags 2.0 **Note:**  Gli smart tag sono deprecati in [!INCLUDE[Excel_14_short](../vsto/includes/excel-14-short-md.md)] e [!INCLUDE[Word_14_short](../vsto/includes/word-14-short-md.md)].|Microsoft.Office.Interop.SmartTag.dll|  
