...
dev_langs: 
  ...
  - "CSharp"
helpviewer_keywords: 
  - "controlli [sviluppo per Office in Visual Studio], informazioni sui controlli in documenti di Office"
  - "documenti di Office [sviluppo per Office in Visual Studio], controlli"
  - "personalizzazioni a livello di documento [sviluppo per Office in Visual Studio], controlli"
  - "controlli [sviluppo per Office in Visual Studio]"
  - "documenti [sviluppo per Office in Visual Studio], controlli"
