...
helpviewer_keywords: 
  ...
  - "Domande frequenti [sviluppo per Office in Visual Studio]"
  - "sviluppo per Office in Visual Studio, domande frequenti"
...
### Controlli su documenti e fogli di lavoro  
...
### Riquadri attività nelle personalizzazioni a livello di documento  
...
### Riquadri attività nei componenti aggiuntivi VSTO  
...
-   [Procedura: visualizzare una stringa in una cella del foglio di lavoro a livello di codice](../vsto/how-to-programmatically-display-a-string-in-a-worksheet-cell.md).  
...
-   [Procedura: ordinare dati nei fogli di lavoro a livello di codice](../vsto/how-to-programmatically-sort-data-in-worksheets.md).  
...
##  <a name="data"></a> Attività relative ai dati  
  
### Controlli con associazione ai dati  
...
### Dati memorizzati nella cache delle soluzioni a livello di documento  
...
##  <a name="server"></a> Attività di gestione dei documenti sul lato server  
...
-   [Procedura: Distribuire una soluzione Office usando ClickOnce](http://msdn.microsoft.com/it-it/2b6c247e-bc04-4ce4-bb64-c4e79bb3d5b8).  
