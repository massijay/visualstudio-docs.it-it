...
###  <a name="WindowsHTML"></a>Sviluppare per dispositivi Windows 10
 ![Dispositivi Windows](~/docs/cross-platform/media/windowsdevices.png "WindowsDevices")
...
##  <a name="CPP"></a>Compilare un'app per Android e Windows (C++)
 ![Usare C&#43;&#43; per creare app per Windows, iOS e Android](~/docs/cross-platform/media/cross_plat_cpp_intro_image.png "Cross_Plat_CPP_Intro_Image")
 ...
 ![Modello di progetto di attività nativa](~/docs/cross-platform/media/cross-plat_cpp_native.png "Cross-Plat_CPP_Native")
...
##  <a name="Unity"></a> Creare un gioco multipiattaforma per Android, iOS e Windows usando Visual Studio Tools per Unity
 ...
 ![Ambiente di sviluppo VSTU](~/docs/cross-platform/media/vstu_overview.png "VSTU_Overview")
