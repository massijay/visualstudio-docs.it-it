...
-   Versione a 64 bit dell'edizione Pro di Windows 8, Windows 8.1, Windows10 o successive.  
 ...
 ![Verificare i requisiti di sistema](~/docs/cross-platform/media/android_emu_system_requirements.png "Android_Emu_System_Requirements")  
...
>  Dopo aver partecipato al gruppo, disconnettersi o riavviare il computer per rendere effettiva la modifica.  
 ...
 ![Aggiunta al gruppo di sicurezza Amministratori Hyper&#45;V](~/docs/cross-platform/media/android_emu_hyperv_admin.png "Android_Emu_HyperV_Admin")  
