...
|-|-|  
|Icona|Descrizione|  
|![Freccia gialla in Stack in parallelo](~/docs/debugger/media/icon_parallelyellowarrow.gif "Icon\_ParallelYellowArrow")|Indica che il contesto del metodo contiene lo stack frame attivo del thread corrente.|  
|![Icona Thread in Stack in parallelo](~/docs/debugger/media/icon_parallelthreads.gif "Icon\_ParallelThreads")|Indica che il contesto del metodo contiene lo stack frame attivo di un thread non corrente.|  
|![Freccia verde in Stack in parallelo](~/docs/debugger/media/icon_parallelgreenarrow.gif "Icon\_ParallelGreenArrow")|Indica che il contesto del metodo contiene lo stack frame corrente.  Il nome del metodo appare in grassetto in tutti i nodi nei quali viene visualizzato.|  
...
-   Quando più attività si trovano in un unico thread, gli stack di chiamate di tali attività vengono suddivisi in nodi separati.  
 ...
 ![Visualizzazione attività nella finestra Stack in parallelo](~/docs/debugger/media/parallel_tasksview.png "Parallel\_TasksView")  
