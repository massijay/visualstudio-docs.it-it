...
-   L'oggetto `D3D11_TEXTURE2D_DESC` passato in `pDesc` descrive una destinazione di rendering, ossia:  
    ...
    -   Il membro BindFlags presenta il flag D3D11\_BIND\_TARGET o il flag D3D11\_BIND\_DEPTH\_STENCIL impostato.  
