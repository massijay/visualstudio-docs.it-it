...
> [!NOTE]
>  Poiché l'enumerazione `CV_HREG_e` è troppo grande per duplicare nel caso di, una versione abbreviata viene fornito come riferimento.  Le voci mancanti notated in corsivo.  Il censimento generale è disponibile nel file di intestazione cvconst.h.  
...
## Elementi  
 CV\_REG\_\*  
 Registrare utilizzati dai processori 80x86 e ix86 Intel e p\- codice.  
  
 CV\_R68\_\*  
 Registrare utilizzati dal processore 68K.  
  
 CV\_M4\_\*  
 I log utilizzati da MIPS un processore a 4000 serie.  
  
 CV\_ALPHA\_\*  
 Registrare utilizzati dal processore di stringa di l Equipment Corporation Alpha AXP.  
  
 CV\_PPC\_\*  
 Registrare utilizzati dal processore Motorola PowerPC\/IBM.  
  
 CV\_SH3\_\* e CV\_SH\_\*  
 Registrare utilizzati processore SH da serie di Hitachi SH3 e di Hitachi.  
  
 CV\_ARM\_\*  
 Registrare utilizzati dai processori avanzati di \(ARM\) del computer RISC.  
  
 CV\_IA64\_\*  
 Registrare utilizzati i processori di serie Intel IA64.  
  
 CV\_TRI\_\*  
 Registrare utilizzati dal processore di Infineon Technologies TriCore.  
  
 CV\_AM33\_\*  
 Registrare utilizzati da Matsushita\/Panasonic AM33 e processori correlati.  
  
 CV\_M32R\_\*  
 Registrare utilizzati dal processore di Mitsubishi M32R.  
  
## Note  
 Ogni tipo di processore utilizza un set univoco di log.  
  
 I valori in questa enumerazione vengono passati ai metodi seguenti:  
