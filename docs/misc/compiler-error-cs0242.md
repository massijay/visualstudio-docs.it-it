...
L'operazione è indefinita sui puntatori a void  
 ...
 L'incremento di un puntatore void non è consentito. Per altre informazioni, vedere [Codice unsafe e puntatori](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
