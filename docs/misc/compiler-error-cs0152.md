...
L'etichetta 'label' è già presente in questa istruzione switch  
 ...
 In un'istruzione [switch](/dotnet/csharp/language-reference/keywords/switch) è stata ripetuta un'etichetta. Per altre informazioni, vedere [switch](/dotnet/csharp/language-reference/keywords/switch).  
