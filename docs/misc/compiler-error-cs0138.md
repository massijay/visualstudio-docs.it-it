...
Una direttiva using dello spazio dei nomi può essere applicata solo a spazi dei nomi. 'type' è un tipo, non uno spazio dei nomi  
 ...
 Una direttiva [using](/dotnet/csharp/language-reference/keywords/using) può assumere come parametro solo il nome di uno spazio dei nomi. Per altre informazioni, vedere [Spazi dei nomi](/dotnet/csharp/programming-guide/namespaces/index).  
