...
Il tipo di variabile locale dichiarato in un'istruzione fixed deve essere un tipo di puntatore  
 ...
 La variabile dichiarata in un'[istruzione fixed](/dotnet/csharp/language-reference/keywords/fixed-statement) deve essere un puntatore. Per altre informazioni, vedere [Codice unsafe e puntatori](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
