...
> [!NOTE]
>  In C\# 2.0 il metodo MoveNext e la proprietà Current vengono generati automaticamente. Per altre informazioni, vedere l'esempio di codice in [Interfacce generiche](/dotnet/csharp/programming-guide/generics/generic-interfaces).  
