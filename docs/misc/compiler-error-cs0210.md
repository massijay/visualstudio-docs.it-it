...
Occorre specificare un inizializzatore nella dichiarazione di un'istruzione fixed o using  
 ...
 È necessario dichiarare e inizializzare la variabile in un'[istruzione fixed](/dotnet/csharp/language-reference/keywords/fixed-statement). Per altre informazioni, vedere [Codice unsafe e puntatori](/dotnet/csharp/programming-guide/unsafe-code-pointers/index).  
...
```  
 ...
 L'esempio seguente genera anche l'errore CS0210 perché l'[istruzione using](/dotnet/csharp/language-reference/keywords/using-statement) non contiene inizializzatori.  
