...
-   Per usare una delle specifiche `CString`, come [Type Conversion Functions](/dotnet/visual-basic/language-reference/functions/type-conversion-functions), è necessario usare il nome della funzione anziché `CType`. In questo caso è richiesto un solo argomento.  
