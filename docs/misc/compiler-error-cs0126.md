...
È necessario un oggetto di un tipo convertibile in 'type'  
 ...
 Un'istruzione return è presente, ma non restituisce un valore del tipo previsto. Per altre informazioni, vedere [Proprietà](/dotnet/csharp/programming-guide/classes-and-structs/properties).  
