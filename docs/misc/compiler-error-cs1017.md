...
Le clausole catch non possono seguire la clausola catch generale di un'istruzione try  
 ...
 Un blocco `catch` che non accetta parametri deve essere l'ultimo in una serie di blocchi `catch`. Per altre informazioni sulle eccezioni, vedere [Istruzioni di gestione delle eccezioni](/dotnet/csharp/language-reference/keywords/exception-handling-statements).  
