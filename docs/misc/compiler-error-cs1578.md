...
È previsto un nome di file, un commento su una sola riga o la fine della riga  
 ...
 Dopo una direttiva [\#line](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-line) è consentito solo un nome file \(tra virgolette doppie\) o un commento su una sola riga.  
