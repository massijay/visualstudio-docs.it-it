...
La parola chiave 'new' non è consentita negli elementi definiti in uno spazio dei nomi  
 ...
 Non è necessario specificare la parola chiave [new](/dotnet/csharp/language-reference/keywords/new) nei costrutti inclusi in [namespace](/dotnet/csharp/language-reference/keywords/namespace).  
