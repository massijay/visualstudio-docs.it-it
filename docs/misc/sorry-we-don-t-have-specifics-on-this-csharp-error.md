...
Siamo spiacenti, ma non abbiamo informazioni specifiche sull'errore.  È possibile cercare il numero dell'errore e il testo del messaggio per trovare informazioni sul Web.  In alternativa, è possibile chiedere ad altri sviluppatori che usano uno di questi forum:  
 ...
 Forum dedicato a domande e discussioni di carattere generale relative al linguaggio e alla sintassi di [!INCLUDE[csprcs](../data-tools/includes/csprcs_md.md)].  
 ...
 Forum dedicato a domande e problemi relativi a [!INCLUDE[csprcs](../data-tools/includes/csprcs_md.md)] non trattati in altri forum.  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/c%23)  
 Forum dedicato a domande e problemi relativi a [!INCLUDE[csprcs](../data-tools/includes/csprcs_md.md)].  
