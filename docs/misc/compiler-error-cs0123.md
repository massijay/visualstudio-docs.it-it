...
Nessun overload per 'method' corrisponde al delegato 'delegate'  
 ...
 È possibile risolvere l'errore modificando il metodo o la firma del delegato. Per altre informazioni, vedere [Delegati](/dotnet/csharp/programming-guide/delegates/index).  
