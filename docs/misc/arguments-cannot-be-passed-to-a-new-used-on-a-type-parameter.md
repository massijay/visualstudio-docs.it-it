...
Una dichiarazione o istruzione di assegnazione invoca un tipo generico e fornisce gli argomenti del costruttore a un parametro di tipo con il vincolo [New Operator](/dotnet/visual-basic/language-reference/operators/new-operator).  
