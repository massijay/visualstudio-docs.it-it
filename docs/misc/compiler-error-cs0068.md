...
'event': l'evento nell'interfaccia non può avere un inizializzatore  
 ...
 Un evento in un'interfaccia non può avere un inizializzatore. Per altre informazioni, vedere [Interfacce](/dotnet/csharp/programming-guide/interfaces/index).  
