...
'member': il nuovo membro protected è stato dichiarato nella classe sealed  
 ...
 Una classe [sealed](/dotnet/csharp/language-reference/keywords/sealed) non può introdurre un membro [protected](/dotnet/csharp/language-reference/keywords/protected) perché nessun'altra classe potrà ereditare dalla classe `sealed` e usare il membro `protected`.  
