...
Un argomento ref o out deve essere una variabile assegnabile  
 ...
 Solo una variabile può essere passata come parametro [ref](/dotnet/csharp/language-reference/keywords/ref) in una chiamata al metodo. Un valore `ref` corrisponde a passare un puntatore.  
