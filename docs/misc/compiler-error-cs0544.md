...
'property override': non è possibile eseguire l'override. 'non\-property' non è una proprietà  
 ...
 Si è provato a eseguire l'override di un tipo di dati non di proprietà come [proprietà](/dotnet/csharp/programming-guide/classes-and-structs/properties), ma questa operazione non è consentita.  
