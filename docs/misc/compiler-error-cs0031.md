...
Non è possibile convertire il valore costante 'value' in 'type'. Usare la sintassi 'unchecked' per eseguire l'override  
 ...
 Si è provato ad assegnare un valore a una variabile il cui tipo non può archiviare il valore. Per altre informazioni, vedere [Tipi](/dotnet/csharp/programming-guide/types/index).  
