...
Non è possibile creare matrici con dimensioni negative  
 ...
 Una dimensione della matrice è stata specificata con un numero negativo. Per altre informazioni, vedere [Matrici](/dotnet/csharp/programming-guide/arrays/index).  
