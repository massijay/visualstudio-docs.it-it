...
Impossibile applicare l'indicizzazione con \[\] a un'espressione di tipo 'type'  
 ...
 Si è provato ad accedere a un valore tramite l'applicazione di un indicizzatore a un tipo di dati che non supporta [Indicizzatori](/dotnet/csharp/programming-guide/indexers/index).  
