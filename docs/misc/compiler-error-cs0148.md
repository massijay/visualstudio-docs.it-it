...
Il delegato 'delegato' non presenta un costruttore valido  
 ...
 È stato importato e usato un programma \(che usa Common Language Runtime di .NET Framework\) creato con un altro compilatore. Il compilatore ha consentito un costruttore [delegate](/dotnet/csharp/language-reference/keywords/delegate) il cui formato non è corretto. Per altre informazioni, vedere [Delegati](/dotnet/csharp/programming-guide/delegates/index).