...
'event': l'evento deve essere di un tipo delegato  
 ...
 La parola chiave event richiede un tipo [delegate](/dotnet/csharp/language-reference/keywords/delegate). Per altre informazioni, vedere [Eventi](/dotnet/csharp/programming-guide/events/index) e [Delegati](/dotnet/csharp/programming-guide/delegates/index).  
