...
La direttiva using per 'namespace' è già presente in questo spazio dei nomi  
 ...
 Uno [spazio dei nomi](/dotnet/csharp/language-reference/keywords/namespace),che deve essere dichiarato una sola volta, è stato invece dichiarato più volte. Rimuovere tutte le dichiarazioni dello spazio dei nomi duplicate.  
