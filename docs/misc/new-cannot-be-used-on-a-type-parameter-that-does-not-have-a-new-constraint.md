...
Un'istruzione di dichiarazione usa una clausola [New Operator](/dotnet/visual-basic/language-reference/operators/new-operator) che specifica un parametro di tipo come tipo da creare e il parametro di tipo viene dichiarato senza un vincolo `New`.  
