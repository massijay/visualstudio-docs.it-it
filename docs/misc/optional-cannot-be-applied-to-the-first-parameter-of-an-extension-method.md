...
Impossibile applicare 'Optional' al primo parametro di un metodo di estensione. Il primo parametro specifica il tipo da estendere.  
 ...
 La restrizione si applica solo al primo parametro. Altri parametri possono essere facoltativi oppure no, seguendo le stesse regole di qualsiasi altro metodo. Per altre informazioni, vedere [Parameter List](/dotnet/visual-basic/language-reference/statements/parameter-list).  
