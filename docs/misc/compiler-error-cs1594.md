...
Il delegato 'delegate' ha argomenti non validi  
 ...
 Il tipo di un argomento passato alla chiamata di un [delegato](/dotnet/csharp/language-reference/keywords/delegate) non corrisponde al tipo del parametro nella dichiarazione del delegato.  
