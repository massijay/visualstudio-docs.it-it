...
'interface' è già contenuto nell'elenco delle interfacce  
 ...
 Un elenco di ereditarietà dell'interfaccia include un duplicato. Un'[interfaccia](/dotnet/csharp/language-reference/keywords/interface) può essere specificata una sola volta nell'elenco di ereditarietà.  
