...
L'operatore unario di overload 'operator' accetta un parametro  
 ...
 La definizione di un [operatore che supporta l'overload](/dotnet/csharp/programming-guide/statements-expressions-operators/overloadable-operators) unario deve accettare un parametro.  
