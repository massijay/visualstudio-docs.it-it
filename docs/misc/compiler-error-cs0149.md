...
È previsto il nome di un metodo  
 ...
 Quando si crea un oggetto [delegate](/dotnet/csharp/language-reference/keywords/delegate), specificare un metodo. Per altre informazioni, vedere [Delegati](/dotnet/csharp/programming-guide/delegates/index).  
