...
In un'espressione stackalloc occorre specificare \[\] dopo il tipo  
 ...
 Le dimensioni dell'allocazione richiesta, con [stackalloc](/dotnet/csharp/language-reference/keywords/stackalloc), devono essere specificate tra parentesi quadre.  
