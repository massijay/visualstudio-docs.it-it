...
Il parametro params deve essere una matrice unidimensionale  
 ...
 Quando si usa la parola chiave [params](/dotnet/csharp/language-reference/keywords/params), è necessario specificare una matrice unidimensionale del tipo di dati. Per altre informazioni, vedere [Metodi](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
