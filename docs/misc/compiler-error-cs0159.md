...
L'etichetta 'label' non esiste nell'ambito dell'istruzione goto  
 ...
 Non è stato possibile trovare l'etichetta a cui fa riferimento l'istruzione [goto](/dotnet/csharp/language-reference/keywords/goto) nell'ambito dell'istruzione `goto`.  
