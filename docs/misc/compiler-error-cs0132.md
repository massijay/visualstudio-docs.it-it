...
'constructor': un costruttore statico non deve avere parametri  
 ...
 Un costruttore [static](/dotnet/csharp/language-reference/keywords/static) non può essere dichiarato con uno o più parametri. Per altre informazioni, vedere [Costruttori](/dotnet/csharp/programming-guide/classes-and-structs/constructors).  
