...
-   la proprietà della classe base non è dichiarata come [virtuale](/dotnet/csharp/language-reference/keywords/virtual).  
  
-   la proprietà della classe base non dichiara la funzione di accesso [get](/dotnet/csharp/language-reference/keywords/get) o [set](/dotnet/csharp/language-reference/keywords/set) di cui si sta provando a eseguire l'override.  
  
 Se non si vuole eseguire l'override della proprietà della classe base, è possibile usare la parola chiave [new](/dotnet/csharp/language-reference/keywords/new) prima della proprietà nella classe derivata.  
  
 Per altre informazioni, vedere [Utilizzo delle proprietà](/dotnet/csharp/programming-guide/classes-and-structs/using-properties).  
...
## Vedere anche  
 [Proprietà](/dotnet/csharp/programming-guide/classes-and-structs/properties)