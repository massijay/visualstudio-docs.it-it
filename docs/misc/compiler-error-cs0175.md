...
Utilizzo della parola chiave 'base' non valido in questo contesto  
 ...
 La parola chiave [base](/dotnet/csharp/language-reference/keywords/base) deve essere usata per specificare un particolare membro della classe base. Per altre informazioni, vedere [Costruttori](/dotnet/csharp/programming-guide/classes-and-structs/constructors).  
