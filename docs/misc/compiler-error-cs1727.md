...
Impossibile inviare automaticamente la segnalazione errori senza autorizzazione. Visitare '' per autorizzare l'invio della segnalazione errori.  
 ...
 Il sito Web indicato nel testo dell'errore illustra come abilitare la segnalazione errori automatica per gli strumenti della riga di comando di [!INCLUDE[vsprvslong](../code-quality/includes/vsprvslong_md.md)].  
