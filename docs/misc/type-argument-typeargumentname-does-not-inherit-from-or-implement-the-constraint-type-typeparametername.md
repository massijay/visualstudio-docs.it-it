...
-   L'argomento di tipo deve ereditare al massimo da una classe  
 ...
 È possibile combinare i requisiti precedenti per un parametro di tipo singolo.[!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)]non può creare il tipo a meno che il codice non fornisca gli argomenti di tipo che soddisfano ogni vincolo su ogni parametro di tipo definito nel tipo generico.  
