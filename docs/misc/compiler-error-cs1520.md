...
Il metodo deve avere un tipo restituito  
 ...
 Un metodo dichiarato in una classe, in uno struct o in un'interfaccia deve includere un tipo restituito esplicito. Nell'esempio seguente, il metodo Square ha un valore restituito [string](/dotnet/csharp/language-reference/keywords/string):  
...
## Vedere anche  
 [Metodi](/dotnet/csharp/programming-guide/classes-and-structs/methods)   
 [Costruttori](/dotnet/csharp/programming-guide/classes-and-structs/constructors)