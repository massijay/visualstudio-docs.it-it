...
'\(' imprevisto. Non sono consentite matrici di tipi generici privi di istanze.  
 ...
 [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] non può compilare una matrice a meno che non sia un tipo di dati specifico. Non è possibile usare un parametro del tipo di dati di un tipo generico come tipo di dati di una matrice.  
