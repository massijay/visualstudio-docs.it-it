...
'constructor': le struct non possono chiamare costruttori della classe base  
 ...
 Uno [struct](/dotnet/csharp/language-reference/keywords/struct) non può chiamare un costruttore della classe base. Rimuovere la chiamata al costruttore della classe base.  
