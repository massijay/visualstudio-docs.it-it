...
Gli identificatori predefiniti dei parametri non sono consentiti  
 ...
 I [parametri del metodo](/dotnet/csharp/language-reference/keywords/method-parameters) non possono avere valori predefiniti. Se si vuole ottenere lo stesso effetto, usare l'overload del metodo. Per altre informazioni, vedere [Passaggio di parametri](/dotnet/csharp/programming-guide/classes-and-structs/passing-parameters).  
