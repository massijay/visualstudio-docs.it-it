...
Il parametro params deve essere l'ultimo in un elenco di parametri formali.  
 ...
 Il parametro [params](/dotnet/csharp/language-reference/keywords/params) supporta un numero variabile di argomenti e deve essere seguire tutti gli altri parametri. Per altre informazioni, vedere [Metodi](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
