...
Si è verificato un errore nell'inizializzazione di una classe. L'installazione di [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] potrebbe essere danneggiata.  
...
2.  Reinstallare [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] e ricompilare il programma.  
