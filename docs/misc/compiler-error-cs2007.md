...
Opzione non riconosciuta della riga di comando: 'opzione'  
 ...
 Al compilatore è stata passata una stringa che non è un'[opzione del compilatore](/dotnet/csharp/language-reference/compiler-options/index), anche se inizia con una barra \(\/\).  
