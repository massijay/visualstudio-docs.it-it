...
'variable': un campo non può essere sia volatile che readonly  
 ...
 Le parole chiave [volatile](/dotnet/csharp/language-reference/keywords/volatile) e [readonly](/dotnet/csharp/language-reference/keywords/readonly) si escludono reciprocamente.  
