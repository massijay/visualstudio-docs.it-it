...
Il tipo 'type' nell'elenco di interfacce non è un'interfaccia  
 ...
 Un oggetto [struct](/dotnet/csharp/language-reference/keywords/struct) o [interface](/dotnet/csharp/language-reference/keywords/interface) può ereditare da un'altra interfaccia, ma non da un altro tipo.  
