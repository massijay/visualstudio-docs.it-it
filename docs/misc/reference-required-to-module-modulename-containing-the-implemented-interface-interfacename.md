...
È necessario il riferimento al modulo '\<nomemodulo\>' contenente l'interfaccia implementata '\<nomeinterfaccia\>'. Aggiungerne uno al progetto.  
 ...
 L'interfaccia è definita in un modulo a cui non si fa riferimento direttamente nel progetto. Il compilatore [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] richiede un riferimento per evitare ambiguità nel caso in cui l'interfaccia sia definita in più di un modulo.  
