...
Il commento XML in 'construct' presenta un formato XML errato \- 'reason'  
 ...
 Quando si usa [\/doc](/dotnet/csharp/language-reference/compiler-options/doc-compiler-option), i commenti nel codice sorgente devono avere il formato XML. Gli errori relativi al markup XML generano l'avviso CS1570. Ad esempio:  
