...
Il membro obsoleto 'memberA' esegue l'override del membro non obsoleto 'memberB'.  
 ...
 In genere, un membro contrassegnato come obsoleto non deve eseguire l'override di un membro che non è contrassegnato come obsoleto. Questo avviso viene generato in [!INCLUDE[vs_orcas_long](../debugger/includes/vs_orcas_long_md.md)] ma non in [!INCLUDE[vsprvslong](../code-quality/includes/vsprvslong_md.md)].  
