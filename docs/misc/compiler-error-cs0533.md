...
'derived\-class member' nasconde il membro astratto ereditato 'base\-class member'  
 ...
 Un metodo della [classe](/dotnet/csharp/language-reference/keywords/class) base è nascosto. Verificare che la sintassi della dichiarazione sia corretta.  
  
 Per altre informazioni, vedere [base](/dotnet/csharp/language-reference/keywords/base).  
