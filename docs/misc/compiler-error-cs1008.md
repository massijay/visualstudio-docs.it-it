...
È previsto il tipo byte, sbyte, short, ushort, int, uint, long o ulong  
 ...
 Alcuni tipi di dati, ad esempio [enums](/dotnet/csharp/language-reference/keywords/enum), possono essere dichiarati solo per contenere i dati dei tipi specificati.  
