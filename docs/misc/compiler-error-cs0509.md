...
'class1': non può derivare dal tipo sealed 'class2'  
 ...
 Una classe [sealed](/dotnet/csharp/language-reference/keywords/sealed) non può essere usata come classe [base](/dotnet/csharp/language-reference/keywords/base). Gli struct sono sealed per impostazione predefinita.  
