...
Le dichiarazioni parziali di 'type' devono essere costituite solo da classi, strutture o interfacce  
 ...
 Questo errore si verifica quando un tipo parziale viene dichiarato come tipo di costrutto differente in varie posizioni. Per altre informazioni, vedere [Classi e metodi parziali](/dotnet/csharp/programming-guide/classes-and-structs/partial-classes-and-methods).  
