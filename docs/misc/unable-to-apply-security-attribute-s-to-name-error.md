...
3.  Se l'errore si ripresenta, salvare il lavoro e riavviare [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
  
4.  Se l'errore si ripete, reinstallare [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
