...
È previsto un identificatore, mentre 'keyword' è una parola chiave  
 ...
 È stata rilevata una parola riservata per il linguaggio C\#, mentre era previsto un identificatore. Sostituire la [parola chiave](/dotnet/csharp/language-reference/keywords/index) con un identificatore specificato dall'utente.  
