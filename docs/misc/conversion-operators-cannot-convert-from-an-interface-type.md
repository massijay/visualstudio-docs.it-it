...
Un operatore di conversione è dichiarato con un tipo di interfaccia per il parametro.  
 ...
 In fase di compilazione, [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] considera come esistente una conversione predefinita da una qualsiasi interfaccia a un qualsiasi tipo riferimento. Questo tipo di conversione potrebbe non riuscire in fase di esecuzione, tuttavia il compilatore non può prevedere i risultati in fase di esecuzione, quindi ne consente la compilazione.  
