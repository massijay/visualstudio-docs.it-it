...
Uso del campo 'field' probabilmente non assegnato  
 ...
 Un campo in una struttura è stato usato senza essere stato prima inizializzato. Per risolvere il problema, determinare prima di tutto il campo che non è stato inizializzato e quindi inizializzarlo prima di provare ad accedervi. Per altre informazioni sull'inizializzazione di struct, vedere [Struct](/dotnet/csharp/programming-guide/classes-and-structs/structs) e [Utilizzo di struct](/dotnet/csharp/programming-guide/classes-and-structs/using-structs).  
