...
'member' nella dichiarazione esplicita dell'interfaccia non è un membro dell'interfaccia  
 ...
 Si è provato a dichiarare esplicitamente un membro di [interfaccia](/dotnet/csharp/language-reference/keywords/interface) che non esiste. Eliminare la dichiarazione o modificarla in modo che faccia riferimento a un membro di interfaccia valido.  
