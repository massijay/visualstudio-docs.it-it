...
È prevista la direttiva \#endregion  
 ...
 Una direttiva [\#region](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-region) non ha una direttiva [\#endregion](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-endregion) corrispondente.  
