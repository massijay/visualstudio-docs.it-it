...
Un elenco di vincoli include sia il vincolo [New Operator](/dotnet/visual-basic/language-reference/operators/new-operator) che il vincolo [Structure \(Visual Basic\)](http://msdn.microsoft.com/it-it/263ce115-ac36-4c05-8cb7-0e0eead5c6d0).  
