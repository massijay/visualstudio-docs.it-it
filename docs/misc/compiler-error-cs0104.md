...
'reference' è un riferimento ambiguo tra 'identifier' e 'identifier'  
 ...
 Il programma contiene direttive [using](/dotnet/csharp/language-reference/keywords/using) per due spazi dei nomi e il codice fa riferimento a un nome presente in entrambi gli spazi dei nomi.  
