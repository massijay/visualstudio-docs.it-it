...
Il nome di parametro 'parameter name' è un duplicato  
 ...
 Una dichiarazione di metodo usa più volte lo stesso nome di parametro. In queste dichiarazioni i nomi di parametro devono essere univoci. Per altre informazioni, vedere [Metodi](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
