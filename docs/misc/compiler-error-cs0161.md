...
'method': non tutti i percorsi del codice restituiscono un valore  
 ...
 Un metodo che restituisce un valore deve avere un'istruzione `return` in tutti i percorsi del codice. Per altre informazioni, vedere [Metodi](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
