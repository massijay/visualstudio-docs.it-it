...
'value' non è un numero di base dell'immagine valido  
 ...
 Un valore non valido \(non numerico\) è stato passato all'opzione del compilatore [\/baseaddress](/dotnet/csharp/language-reference/compiler-options/baseaddress-compiler-option).  
