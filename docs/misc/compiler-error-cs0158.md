...
L'etichetta 'label' è la replica di un'altra etichetta con lo stesso nome in un ambito contenuto  
 ...
 Un'etichetta in un ambito interno nasconde un'etichetta con lo stesso nome in un ambito esterno. Per altre informazioni, vedere [goto](/dotnet/csharp/language-reference/keywords/goto).  
