...
Un metodo parziale non può avere parametri out  
 ...
 Un metodo parziale non può avere un parametro [out](/dotnet/csharp/language-reference/keywords/out). I parametri out non sono consentiti perché se il metodo parziale viene rimosso dal compilatore, non è garantito che il parametro out venga assegnato.  
