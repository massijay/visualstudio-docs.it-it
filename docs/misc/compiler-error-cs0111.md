...
Il tipo 'class' definisce già un membro denominato 'member' con gli stessi tipi di parametro  
 ...
 L'errore CS0111 si verifica se una classe contiene due dichiarazioni di membri con lo stesso nome e gli stessi tipi di parametro. Per altre informazioni, vedere [Metodi](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
