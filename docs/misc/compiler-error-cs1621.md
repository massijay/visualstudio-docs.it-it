...
## Vedere anche  
 ...
 [Espressioni lambda](/dotnet/csharp/programming-guide/statements-expressions-operators/lambda-expressions)   
 [Metodi anonimi](/dotnet/csharp/programming-guide/statements-expressions-operators/anonymous-methods)