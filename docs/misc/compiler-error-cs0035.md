...
L'operatore 'operator' è ambiguo su un operando di tipo 'type'  
 ...
 l compilatore ha a disposizione più conversioni e non è in grado di sceglierne una prima di applicare l'operatore. Per altre informazioni, vedere [Conversioni definite dall'utente basate su modelli](../misc/templated-user-defined-conversions.md) e [Operatori di conversione](/dotnet/csharp/programming-guide/statements-expressions-operators/conversion-operators).  
