...
Il compilatore [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] chiama Assembly Linker \(Al.exe, definito anche Alink\) per generare un assembly con un manifesto. Il linker ha segnalato un errore durante la ricerca di un file di chiave o di un nome di chiave con cui firmare l'assembly.  
