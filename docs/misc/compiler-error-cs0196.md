...
Un puntatore deve essere indicizzato da un solo valore  
 ...
 Un puntatore non può avere più indici. Per altre informazioni, vedere [Tipi di puntatori](/dotnet/csharp/programming-guide/unsafe-code-pointers/pointer-types).  
