...
L'[TextFieldParser Object](/dotnet/visual-basic/language-reference/objects/textfieldparser-object) non può leggere il flusso passato. Può trattarsi di un risultato del tentativo di lettura di un file che non è un file di testo.  
