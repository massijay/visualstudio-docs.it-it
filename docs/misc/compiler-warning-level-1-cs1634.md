...
È previsto disable o restore  
 ...
 Questo errore si verifica quando il formato di una clausola \#pragma warning non è corretto, ad esempio se viene omesso disable o restore. Per altre informazioni, vedere l'argomento [\#pragma warning](/dotnet/csharp/language-reference/preprocessor-directives/preprocessor-pragma-warning).  
