...
Poiché 'function' restituisce void, una parola chiave restituita non deve essere seguita da un'espressione dell'oggetto  
 ...
 Un metodo con un tipo restituito [void](/dotnet/csharp/language-reference/keywords/void) non può restituire un valore. Per altre informazioni, vedere [Metodi](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
