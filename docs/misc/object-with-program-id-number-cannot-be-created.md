...
La stringa della classe che si sta tentando di utilizzare non è valida.  Il messaggio indica un errore del sistema operativo.  
  
### Per correggere l'errore  
  
1.  Reinstallare Visual Studio o l'applicazione interessata, quindi riprovare.