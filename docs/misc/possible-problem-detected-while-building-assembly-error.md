...
Lo strumento ALink, chiamato dal compilatore [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)], segnala un errore durante la compilazione dell'assembly. Una possibile causa è un assembly firmato che fa riferimento a un assembly non firmato.  
  
 Si tratta di un messaggio di avviso. Il compilatore continua a generare l'assembly. Per altre informazioni su come nascondere gli avvisi o considerarli come errori, vedere [Configurazione degli avvisi in Visual Basic](../ide/configuring-warnings-in-visual-basic.md).  
...
3.  Se l'errore si ripresenta, reinstallare il compilatore [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
