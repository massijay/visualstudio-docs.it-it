...
Quando viene richiamato un tipo non generico, una dichiarazione o un'istruzione di assegnazione include una clausola [Of](/dotnet/visual-basic/language-reference/statements/of-clause).  
