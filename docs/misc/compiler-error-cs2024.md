...
Numero di allineamento '\#' della sezione del file non valido  
 ...
 È stato passato un valore non valido all'opzione del compilatore [\/filealign](/dotnet/csharp/language-reference/compiler-options/filealign-compiler-option).  
