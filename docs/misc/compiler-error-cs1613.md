...
-   Aggiungere un riferimento all'assembly che abbia la coclasse. L'interfaccia e la coclasse devono trovarsi quasi sempre nello stesso assembly. Per altre informazioni, vedere [\/reference](/dotnet/csharp/language-reference/compiler-options/reference-compiler-option) o [Finestra di dialogo Aggiungi riferimento](http://msdn.microsoft.com/it-it/2feb0fe2-0805-4cc9-8cba-b0315849dfb7).  
