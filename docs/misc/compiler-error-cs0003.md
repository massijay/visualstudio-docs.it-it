...
Memoria insufficiente  
 ...
 Questo errore può essere causato anche dalla presenza di versioni non corrispondenti di [!INCLUDE[winsdklong](../deployment/includes/winsdklong_md.md)] e del compilatore C\# oppure di uno o più file danneggiati che supportano il compilatore C\#. Reinstallare Visual Studio.