...
'event': l'evento astratto non può avere un inizializzatore  
 ...
 Se un [evento](/dotnet/csharp/language-reference/keywords/event) è contrassegnato come **abstract**, non può essere inizializzato. Per altre informazioni, vedere [Eventi](/dotnet/csharp/programming-guide/events/index).  
