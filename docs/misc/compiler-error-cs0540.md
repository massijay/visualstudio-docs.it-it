...
'interface member': il tipo che lo contiene non implementa l'interfaccia 'interface'  
 ...
 Si è provato a implementare un membro di interfaccia in una [classe](/dotnet/csharp/language-reference/keywords/class) che non deriva dall'[interfaccia](/dotnet/csharp/language-reference/keywords/interface). È necessario eliminare l'implementazione del membro di interfaccia o aggiungere l'interfaccia all'elenco delle classi base della classe.  
