...
Un'espressione usata per un argomento di attributo restituisce un tipo di dati diverso da quello del parametro di attributo corrispondente e [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] non consente la conversione di tipo richiesta per gli argomenti di attributo.  
