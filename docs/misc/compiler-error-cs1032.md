...
Impossibile definire o annullare la definizione dei simboli del preprocessore dopo il primo token nel file  
 ...
 Le [direttive per il preprocessore](/dotnet/csharp/language-reference/preprocessor-directives/index) `#define` e `#undef` devono essere usate all'inizio di un programma, prima delle altre parole chiave, ad esempio quelle usate nella dichiarazione dello spazio dei nomi.  
