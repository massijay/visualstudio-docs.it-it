...
Gli struct non possono contenere costruttori espliciti senza parametri  
 ...
 Ogni [struct](/dotnet/csharp/language-reference/keywords/struct) include già un costruttore predefinito che inizializza l'oggetto sul valore zero. I costruttori creati per uno struct devono quindi accettare uno o più parametri.  
