...
Una classe derivata non dichiara un costruttore e [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] non può generarne uno perché non può determinare quale costruttore della classe base chiamare.  
