...
'type' non è un tipo riferimento richiesto dall'istruzione lock  
 ...
 L'istruzione [lock](/dotnet/csharp/language-reference/keywords/lock-statement) può valutare solo i tipi riferimento. Per altre informazioni, vedere [Sincronizzazione di thread](../Topic/Thread%20Synchronization%20\(C%23%20and%20Visual%20Basic\).md) e [Tipi di riferimento](/dotnet/csharp/language-reference/keywords/reference-types).  
