...
'event': non è possibile eseguire l'override. 'method' non è un evento  
 ...
 Un [evento](/dotnet/csharp/language-reference/keywords/event) può eseguire l'override solo di un altro evento. Per altre informazioni, vedere [Eventi](/dotnet/csharp/programming-guide/events/index).  
