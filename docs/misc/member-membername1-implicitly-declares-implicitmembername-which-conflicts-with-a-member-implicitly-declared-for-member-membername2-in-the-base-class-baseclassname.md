...
-   Se si prevede di nascondere il membro implicito della classe base, includere la parola chiave [Shadows](/dotnet/visual-basic/language-reference/modifiers/shadows) nella dichiarazione del membro della classe derivata.  
