...
Accessibilità incoerente: il tipo parametro 'type' è meno accessibile del delegato 'delegate'  
 ...
 Il tipo restituito e ciascuno dei tipi a cui viene fatto riferimento nell'elenco di parametri formali di un metodo deve essere accessibile almeno quanto il metodo stesso. Per altre informazioni, vedere [Modificatori di accesso](/dotnet/csharp/programming-guide/classes-and-structs/access-modifiers).  
