...
'field declaration': impossibile inizializzare il campo di un'istanza negli struct  
 ...
 Non è possibile inizializzare un campo di istanza di uno [struct](/dotnet/csharp/language-reference/keywords/struct). I campi di tipi valore verranno inizializzati sui relativi valori predefiniti e i campi di tipo riferimento verranno inizializzati su `null`.  
