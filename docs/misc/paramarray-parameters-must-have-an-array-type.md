...
2.  Se l'errore si ripete, salvare il lavoro e riavviare [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
  
3.  Se l'errore persiste, reinstallare [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
