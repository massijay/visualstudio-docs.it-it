...
non può definire metodi di overload che differiscono solo per ref e out.  
 ...
 I metodi che si differenziano solo per l'uso di [ref](/dotnet/csharp/language-reference/keywords/ref) e [out](/dotnet/csharp/language-reference/keywords/out) in un parametro non sono consentiti.  
