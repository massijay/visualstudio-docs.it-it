...
Una variabile locale denominata 'variable' è già definita in quest'ambito  
 ...
 Il compilatore ha rilevato le dichiarazioni di due variabili locali con lo stesso nome. Per altre informazioni, vedere [Metodi](/dotnet/csharp/programming-guide/classes-and-structs/methods).  
