...
'class' non implementa il membro di interfaccia 'member'  
 ...
 Una [classe](/dotnet/csharp/language-reference/keywords/class) è derivata da un'[interfaccia](/dotnet/csharp/language-reference/keywords/interface), ma non ha implementato uno o più membri dell'interfaccia. Una classe deve implementare tutti i membri delle interfacce da cui deriva oppure essere dichiarata `abstract`.  
