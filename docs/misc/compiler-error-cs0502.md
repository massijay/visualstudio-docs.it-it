...
'member' non può essere contemporaneamente abstract e sealed  
 ...
 Un membro di classe non può essere contemporaneamente [abstract](/dotnet/csharp/language-reference/keywords/abstract) e [sealed](/dotnet/csharp/language-reference/keywords/sealed).  
