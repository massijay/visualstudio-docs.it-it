...
Impossibile specificare l'attributo DefaultMember in un tipo contenente un indicizzatore  
 ...
 Se una classe o un altro tipo specifica **System.Reflection.DefaultMemberAttribute**, non può contenere un indicizzatore. Per altre informazioni, vedere [Proprietà](/dotnet/csharp/programming-guide/classes-and-structs/properties).  
