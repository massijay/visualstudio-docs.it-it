...
Il valore letterale carattere è vuoto  
 ...
 [char](/dotnet/csharp/language-reference/keywords/char) è stato dichiarato e inizializzato in un valore Null. L'inizializzazione di `char` deve specificare un carattere.  
