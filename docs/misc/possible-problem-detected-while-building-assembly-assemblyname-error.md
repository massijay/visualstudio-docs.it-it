...
Lo strumento ALink, chiamato dal compilatore [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)], segnala un errore durante la compilazione dell'assembly. Ecco alcune possibili cause:  
