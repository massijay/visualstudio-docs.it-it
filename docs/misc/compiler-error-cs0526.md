...
Le interfacce non possono contenere costruttori  
 ...
 I costruttori non possono essere definiti per le [interfacce](/dotnet/csharp/language-reference/keywords/interface). Un metodo viene considerato un costruttore se ha lo stesso nome della classe e nessun tipo restituito.  
