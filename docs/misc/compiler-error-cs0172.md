...
Non è possibile determinare il tipo di espressione condizionale perché 'type1' e 'type2' sono reciprocamente convertibili in modo implicito  
 ...
 In un'istruzione condizionale, è necessario poter convertire i tipi su entrambi i lati dell'operatore `:`. Inoltre, non possono esistere routine di conversione reciproca; è sufficiente una conversione. Per altre informazioni, vedere [Operatori di conversione](/dotnet/csharp/programming-guide/statements-expressions-operators/conversion-operators).  
