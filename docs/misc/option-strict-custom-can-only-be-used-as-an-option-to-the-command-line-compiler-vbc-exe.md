...
2.  Specificare l'opzione `/optionstrict:custom`. Per altre informazioni, vedere [\/optionstrict](/dotnet/visual-basic/reference/command-line-compiler/optionstrict).  
