...
È previsto un operatore binario che supporti l'overload  
 ...
 Si è provato a definire un [overload degli operatori](/dotnet/csharp/programming-guide/statements-expressions-operators/overloadable-operators), ma l'operatore non è di tipo binario, che accetta due parametri.  
