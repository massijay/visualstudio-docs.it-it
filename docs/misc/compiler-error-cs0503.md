...
Il metodo astratto 'method' non può essere contrassegnato come virtual  
 ...
 È inutile contrassegnare un metodo di membro sia come [abstract](/dotnet/csharp/language-reference/keywords/abstract) che come [virtual](/dotnet/csharp/language-reference/keywords/virtual), in quanto **abstract** implica **virtual**.  
