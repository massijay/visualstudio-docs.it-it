...
L'espressione assegnata a 'variable' deve essere costante  
 ...
 Una variabile [const](/dotnet/csharp/language-reference/keywords/const) non può accettare come valore un'espressione non costante. Per altre informazioni, vedere [Costanti](/dotnet/csharp/programming-guide/classes-and-structs/constants).  
