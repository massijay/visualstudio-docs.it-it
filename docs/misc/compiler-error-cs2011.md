...
Non è possibile aprire il file di risposta 'file'  
 ...
 Per altre informazioni sui file di risposta, vedere [@ \(specifica di un file di risposta\)](/dotnet/csharp/language-reference/compiler-options/response-file-compiler-option).