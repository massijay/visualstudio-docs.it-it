...
La parola chiave 'base' non è disponibile in un metodo statico  
 ...
 La parola chiave [base](/dotnet/csharp/language-reference/keywords/base) è stata usata in un metodo [static](/dotnet/csharp/language-reference/keywords/static).`base` può essere chiamato solo in un costruttore di istanze, un metodo di istanza o una funzione di accesso di istanza.  
