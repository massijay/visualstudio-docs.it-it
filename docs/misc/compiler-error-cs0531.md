...
'member': i membri di interfaccia non possono avere una definizione  
 ...
 I metodi dichiarati in un'[interfaccia](/dotnet/csharp/language-reference/keywords/interface) devono essere implementati in una classe che eredita da questa e non nell'interfaccia stessa.  
