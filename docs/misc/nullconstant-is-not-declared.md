...
2.  Usare la parola chiave [Nothing](/dotnet/visual-basic/language-reference/nothing) per le assegnazioni e i confronti quando si usano le variabili oggetto. Nell'esempio che segue viene illustrato quanto descritto.  
