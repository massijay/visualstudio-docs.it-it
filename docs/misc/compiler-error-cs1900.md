...
Il livello di avviso deve essere compreso tra 0 e 4  
 ...
 L'opzione del compilatore [\/warn](/dotnet/csharp/language-reference/compiler-options/warn-compiler-option) può accettare solo uno dei cinque valori possibili \(0, 1, 2, 3 o 4\). Qualsiasi altro valore passato a **\/warn** genererà l'errore CS1900.  
