...
Un'[Operator Statement](/dotnet/visual-basic/language-reference/statements/operator-statement) è stata inserita in una definizione di modulo.  
...
-   Se è necessario eseguire un'operazione sul modulo, usare un'[Function Statement](/dotnet/visual-basic/language-reference/statements/function-statement) per definire una routine `Function` atta allo scopo.  
