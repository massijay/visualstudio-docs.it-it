...
Un'[Event Statement](/dotnet/visual-basic/language-reference/statements/event-statement) usa un delegato per specificare la sua firma, ma l'[Delegate Statement](/dotnet/visual-basic/language-reference/statements/delegate-statement) è contrassegnata come `<CLSCompliant(False)>` o non è contrassegnata.  
