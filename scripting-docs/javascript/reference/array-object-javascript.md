...
## Proprietà  
 La tabella seguente elenca le proprietà dell'oggetto `Array`.  
...
## Metodi  
 La tabella seguente elenca i metodi dell'oggetto `Array`.  
...
|[Metodo findIndex](../../javascript/reference/findindex-method-array-javascript.md)|Restituisce un valore di indice per il primo elemento della matrice che soddisfa i criteri di test specificati in una funzione di callback.|  
