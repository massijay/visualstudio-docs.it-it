...
|Operatore|Simbolo|  
|--------------|------------|  
|[Aggiunta](../../javascript/reference/addition-assignment-operator-decrement-equal-javascript.md)|+=|  
...
|[Right Shift senza segno](../../javascript/reference/unsigned-right-shift-assignment-operator-decrement-equal-javascript.md)|>>>=|  
