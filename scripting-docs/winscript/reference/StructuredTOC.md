# [Riferimenti interfacce Windows Script](windows-script-interfaces-reference.md)
...
## [Interfacce del debugger dello script ActiveX](active-script-debugger-interfaces.md)
...
### [Interfaccia IActiveScriptSiteDebug Interface](iactivescriptsitedebug-interface.md)
...
#### [Metodo IJsDebugProcess::CreateBreakPoint](ijsdebugprocess-createbreakpoint-method.md)
...
## [Interfacce del profiler dello script ActiveX](active-script-profiler-interfaces.md)
...
#### [](TocOutOfQuery)
#### [Enumerazione PROFILER_INFO_OBJECT_FLAGS](profiler-relationship-info-enumeration.md)
...
### [Interfaccia IPerPropertyBrowsing2](iperpropertybrowsing2-interface-1.md)
