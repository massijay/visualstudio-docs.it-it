...
---
# Metodo IActiveScriptProfilerHeapEnum::FreeObjectAndOptionalInfo
...
#### Parametri  
 ...
 `heapObjects`  
 Matrice di strutture [Struttura PROFILER\_HEAP\_OBJECT](../../winscript/reference/profiler-heap-object-structure.md).  
