...
---
# Scelta del motore Edge o del motore Legacy come destinazione per le API JsRT
...
## Scegliere come destinazione la versione preferita  
...
## Compilare per la versione preferita usando Visual C\+\+  
...
```  
 ...
 ![Aggiunta di jsrt.lib come un file di input del linker](../chakra-hosting/media/js-chakra.png "JS\_Chakra\_")  
...
```  
 ...
 ![Aggiunta di chakrart.lib come un file di input del linker](../chakra-hosting/media/js-chakra-hosting.png "JS\_Chakra\_Hosting\_")  
  
 Se si inizia con una nuova applicazione, è ora possibile cominciare a scrivere codice sull'API JsRT.  
  
## Compilare per la versione preferita usando .NET  
